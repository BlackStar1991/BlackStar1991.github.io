(function ($) {
    ...
    var ssMasonryFolio = function () {
        ...
        containerBricks.imagesLoaded(function () {
            containerBricks.masonry({itemSelector: '.brick', resize: true});
        });
    };
    var ssLightGallery = function () {
        $('#folio-wrap').lightGallery({showThumbByDefault: false, hash: false, selector: ".item-wrap"});
    };
    ...
    $(".btn_showSomeText").on("click", function(){
       $(".sometext").slideDown(400);
       $(this).remove();
    });
    ...
    var ssOffCanvas = function () {
        var menuTrigger = $('#header-menu-trigger'), nav = $('#menu-nav-wrap'), closeButton = nav.find('.close-button'),
                    ...
                    if (direction === 'down' && !$(this.element).hasClass('animated')) {
                        ...
                        setTimeout(function () {
                            $('body .animate-this.item-animate').each(function (ctr) {
                                var el = $(this), animationEfx = el.data('animate') || null;
                                if (!animationEfx) {
