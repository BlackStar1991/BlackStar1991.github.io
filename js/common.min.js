window.onload = function () {
    ...
    var btn_partners = $(".btn_navigation");
    btn_partners.on("click", function () {
...
////// Paralax
    ...
    if (body.width() > 1490) {
        ...
        var cards = $('.bl_topCasinos__list .aside_block__item');

        cards.each((index, card) => {
            $(card).prepend("<div class='shineLayer'></div>")
        });

        cards.mousemove(function (event) {
        ...
        cards.mouseleave(function (event) {
            var card = this;
...
/////////////
    ...
    closeButtonGetBonus.on("click", function () {
        btnGetBonus.removeClass(active);
        btnGetBonus.css("display","none");
    })
