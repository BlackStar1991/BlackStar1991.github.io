window.onload = function () {
    ...
    var buttonsCat = $(".price_header"),
        sectionsPrice = $('.price_item');


    buttonsCat.on("click", function () {
       var thisNum = $(this).data('number');

        buttonsCat.removeClass(active);
        $(this).addClass(active);

        sectionsPrice.removeClass(active);
        $(".price_item[data-number=" + thisNum + "]").addClass(active);
