$(document).ready(function () {
    ...
    var careerSection = $(".bl_career"),
        careerHeight = (careerSection.offset(top)) + (careerSection.height()) * 11,

        coinCareerLeft1 = $(".decor_coins__a"),
        coinCareerLeft2 = $(".decor_coins__a_left2"),
        coinCareerRight1 = $(".decor_coins__b");
