...
!function(t) {
    !function(t) {
        ...
        t.Animation = i,
            function(t) {
                t[t.setup = 0] = "setup",
                    t[t.current = 1] = "current",
                    t[t.currentLayered = 2] = "currentLayered"
        ...
        var a = function() {
            function e(n) {
                if (n <= 0)
                    throw new Error("frameCount must be > 0: " + n);
            ...
            return e.prototype.getFrameCount = function() {
                ...
                e.prototype.setCurve = function(t, n, r, i, a) {
                    var o = .03 * (2 * -n + i)
                        ...
                        , m = this.curves;
                    m[d++] = e.BEZIER;
                    for (var g = p, v = f, y = d + e.BEZIER_SIZE - 1; d < y; d += 2)
                        m[d] = g,
                            m[d + 1] = v,
                            p += u,
                            f += c,
        ...
        var o = function(n) {
            function a(e) {
                ...
                return r.frames = t.Utils.newFloatArray(e << 1),
                    r
            }
            return __extends(a, n),
                ...
                a.prototype.setFrame = function(t, e, n) {
                    t <<= 1,
                        this.frames[t] = e,
                        this.frames[t + a.ROTATION] = n
                }
                ,
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    var u = this.frames
                    ...
                    if (r < u[0])
                    ...
                    else if (r >= u[u.length - a.ENTRIES])
                        if (l == e.setup)
                            c.rotation = c.data.rotation + u[u.length + a.PREV_ROTATION] * s;
                        else {
                        ...
                        var d = i.binarySearch(u, r, a.ENTRIES)
                            , m = u[d + a.PREV_ROTATION]
                            , g = u[d]
                            , v = this.getCurvePercent((d >> 1) - 1, 1 - (r - g) / (u[d + a.PREV_TIME] - g))
                            , y = u[d + a.ROTATION] - m;
                        y = m + (y -= 360 * (16384 - (16384.499999999996 - y / 360 | 0))) * v,
                            l == e.setup ? (y -= 360 * (16384 - (16384.499999999996 - y / 360 | 0)),
                                c.rotation = c.data.rotation + y * s) : (y = c.data.rotation + y - c.rotation,
        ...
        var s = function(n) {
            function a(e) {
                var r = n.call(this, e) || this;
                return r.frames = t.Utils.newFloatArray(e * a.ENTRIES),
                    r
            }
            return __extends(a, n),
                a.prototype.getPropertyId = function() {
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < u[0])
                        ...
                        var p = 0
                            , f = 0;
                        if (r >= u[u.length - a.ENTRIES])
                            p = u[u.length + a.PREV_X],
                                f = u[u.length + a.PREV_Y];
                        else {
                            var d = i.binarySearch(u, r, a.ENTRIES);
                            p = u[d + a.PREV_X],
                                f = u[d + a.PREV_Y];
                            var m = u[d]
                                , g = this.getCurvePercent(d / a.ENTRIES - 1, 1 - (r - m) / (u[d + a.PREV_TIME] - m));
                            p += (u[d + a.X] - p) * g,
                                f += (u[d + a.Y] - f) * g
                        }
                        l == e.setup ? (c.x = c.data.x + p * s,
                            c.y = c.data.y + f * s) : (c.x += (c.data.x + p - c.x) * s,
                            c.y += (c.data.y + f - c.y) * s)
                    }
                }
                ,
                a.ENTRIES = 3,
        ...
        var l = function(a) {
            ...
            return __extends(o, a),
                o.prototype.getPropertyId = function() {
                    return (r.scale << 24) + this.boneIndex
                }
                ,
                o.prototype.apply = function(r, a, s, l, h, u, c) {
                    var p = this.frames
                        , f = r.bones[this.boneIndex];
                    if (s < p[0])
                        switch (u) {
                            case e.setup:
                                return f.scaleX = f.data.scaleX,
                                    void (f.scaleY = f.data.scaleY);
                            case e.current:
                                f.scaleX += (f.data.scaleX - f.scaleX) * h,
                                    f.scaleY += (f.data.scaleY - f.scaleY) * h
                        }
                    else {
                        var d = 0
                            , m = 0;
                        if (s >= p[p.length - o.ENTRIES])
                            d = p[p.length + o.PREV_X] * f.data.scaleX,
                                m = p[p.length + o.PREV_Y] * f.data.scaleY;
                        else {
                            var g = i.binarySearch(p, s, o.ENTRIES);
                            d = p[g + o.PREV_X],
                                m = p[g + o.PREV_Y];
                            var v = p[g]
                                , y = this.getCurvePercent(g / o.ENTRIES - 1, 1 - (s - v) / (p[g + o.PREV_TIME] - v));
                            d = (d + (p[g + o.X] - d) * y) * f.data.scaleX,
                                m = (m + (p[g + o.Y] - m) * y) * f.data.scaleY
                        }
                        if (1 == h)
                            f.scaleX = d,
                                f.scaleY = m;
                            ...
                            var x = 0
                                , M = 0;
                            u == e.setup ? (x = f.data.scaleX,
                                M = f.data.scaleY) : (x = f.scaleX,
                                M = f.scaleY),
                                c == n.out ? (d = Math.abs(d) * t.MathUtils.signum(x),
                                    m = Math.abs(m) * t.MathUtils.signum(M)) : (x = Math.abs(x) * t.MathUtils.signum(d),
                                    M = Math.abs(M) * t.MathUtils.signum(m)),
                                f.scaleX = x + (d - x) * h,
                                f.scaleY = M + (m - M) * h
                        }
                    }
        ...
        var h = function(t) {
            ...
            return __extends(n, t),
                ...
                ,
                n.prototype.apply = function(t, r, a, o, s, l, h) {
                    var u = this.frames
                        , c = t.bones[this.boneIndex];
                    if (a < u[0])
                        switch (l) {
                            ...
                            case e.current:
                                c.shearX += (c.data.shearX - c.shearX) * s,
                                    c.shearY += (c.data.shearY - c.shearY) * s
                        }
                    else {
                        var p = 0
                            , f = 0;
                        if (a >= u[u.length - n.ENTRIES])
                            p = u[u.length + n.PREV_X],
                                f = u[u.length + n.PREV_Y];
                        else {
                            var d = i.binarySearch(u, a, n.ENTRIES);
                            p = u[d + n.PREV_X],
                                f = u[d + n.PREV_Y];
                            var m = u[d]
                                , g = this.getCurvePercent(d / n.ENTRIES - 1, 1 - (a - m) / (u[d + n.PREV_TIME] - m));
                            p += (u[d + n.X] - p) * g,
                                f += (u[d + n.Y] - f) * g
                        }
                        l == e.setup ? (c.shearX = c.data.shearX + p * s,
                            c.shearY = c.data.shearY + f * s) : (c.shearX += (c.data.shearX + p - c.shearX) * s,
                            c.shearY += (c.data.shearY + f - c.shearY) * s)
                    }
                }
                ,
                n
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < c[0])
                        ...
                        if (r >= c[c.length - a.ENTRIES]) {
                            ...
                            var x = i.binarySearch(c, r, a.ENTRIES);
                            d = c[x + a.PREV_R],
                                m = c[x + a.PREV_G],
                                g = c[x + a.PREV_B],
                                v = c[x + a.PREV_A];
                            var M = c[x]
                                , w = this.getCurvePercent(x / a.ENTRIES - 1, 1 - (r - M) / (c[x + a.PREV_TIME] - M));
                            d += (c[x + a.R] - d) * w,
                                m += (c[x + a.G] - m) * w,
                                g += (c[x + a.B] - g) * w,
                                v += (c[x + a.A] - v) * w
                        ...
                        if (1 == s)
                            ...
                            p = u.color;
                            l == e.setup && p.setFromColor(u.data.color),
                                p.add((d - p.r) * s, (m - p.g) * s, (g - p.b) * s, (v - p.a) * s)
                        }
                    }
                }
                ,
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < c[0])
                        switch (l) {
                            ...
                            case e.current:
                                ...
                                p.add((d.r - p.r) * s, (d.g - p.g) * s, (d.b - p.b) * s, (d.a - p.a) * s),
                                    f.add((m.r - f.r) * s, (m.g - f.g) * s, (m.b - f.b) * s, 0)
                        }
                    else {
                        var g = 0
                            , v = 0
                        ...
                        if (r >= c[c.length - a.ENTRIES]) {
                            ...
                            var b = i.binarySearch(c, r, a.ENTRIES);
                            g = c[b + a.PREV_R],
                                v = c[b + a.PREV_G],
                                y = c[b + a.PREV_B],
                                x = c[b + a.PREV_A],
                                ...
                                E = c[b + a.PREV_B2];
                            var A = c[b]
                                , I = this.getCurvePercent(b / a.ENTRIES - 1, 1 - (r - A) / (c[b + a.PREV_TIME] - A));
                            g += (c[b + a.R] - g) * I,
                                v += (c[b + a.G] - v) * I,
                                y += (c[b + a.B] - y) * I,
                                x += (c[b + a.A] - x) * I,
                        ...
                        if (1 == s)
                            u.color.set(g, v, y, x),
                                u.darkColor.set(M, w, E, 1);
                        else {
                            p = u.color,
                                f = u.darkColor;
                            l == e.setup && (p.setFromColor(u.data.color),
                                f.setFromColor(u.data.darkColor)),
                                p.add((g - p.r) * s, (v - p.g) * s, (y - p.b) * s, (x - p.a) * s),
                                f.add((M - f.r) * s, (w - f.g) * s, (E - f.b) * s, 0)
                        }
                    }
                }
                ,
        ...
        var p = function() {
            ...
            return a.prototype.getPropertyId = function() {
                ...
                ,
                a.prototype.apply = function(t, r, a, o, s, l, h) {
                    var u = t.slots[this.slotIndex];
                    if (h != n.out || l != e.setup) {
                        var c = this.frames;
                        if (a < c[0]) {
                            if (l == e.setup) {
                            ...
                            var f = 0;
                            f = a >= c[c.length - 1] ? c.length - 1 : i.binarySearch(c, a, 1) - 1;
        ...
        var f = null
            ...
            function a(e) {
                var r = n.call(this, e) || this;
                return r.frames = t.Utils.newFloatArray(e),
                    r.frameVertices = new Array(e),
            ...
            return __extends(a, n),
                ...
                ,
                a.prototype.apply = function(n, r, a, o, s, l, h) {
                        ...
                        if (a < m[0]) {
                            ...
                            switch (l) {
                                ...
                                case e.current:
                                    ...
                                    var v = t.Utils.setArraySize(p, d);
                                    if (null == g.bones)
                                        for (var y = g.vertices, x = 0; x < d; x++)
                                            v[x] += (y[x] - v[x]) * s;
                                    else {
                                        s = 1 - s;
                                        for (x = 0; x < d; x++)
                            ...
                            var M = t.Utils.setArraySize(p, d);
                            if (a >= m[m.length - 1]) {
                                var w = f[m.length - 1];
                                if (1 == s)
                                    t.Utils.arrayCopy(w, 0, M, 0, d);
                                else if (l == e.setup) {
                                    if (null == (g = c).bones)
                                        for (y = g.vertices,
                                                 x = 0; x < d; x++) {
                                ...
                                var T = i.binarySearch(m, a)
                                    , b = f[T - 1]
                                    , A = f[T]
                                    , I = m[T]
                                    , S = this.getCurvePercent(T - 1, 1 - (a - I) / (m[T - 1] - I));
                                if (1 == s)
                                    for (x = 0; x < d; x++) {
                                        var R = b[x];
                                        M[x] = R + (A[x] - R) * S
        ...
        var m = function() {
            ...
            return e.prototype.getPropertyId = function() {
                ...
                ,
                e.prototype.apply = function(t, e, n, r, a, o, s) {
                    if (null != r) {
                        var l = this.frames
                            , h = this.frames.length;
                        if (e > n)
                            this.apply(t, e, Number.MAX_VALUE, r, a, o, s),
                                e = -1;
                        else if (e >= l[h - 1])
                            return;
                        if (!(n < l[0])) {
                            ...
                            if (e < l[0])
                                ...
                                for (var c = l[u = i.binarySearch(l, e)]; u > 0 && l[u - 1] == c; )
                                    u--;
                            for (; u < h && n >= l[u]; u++)
        ...
        var g = function() {
            ...
            return a.prototype.getPropertyId = function() {
                ...
                ,
                a.prototype.apply = function(r, a, o, s, l, h, u) {
                    var c = r.drawOrder
                        , p = r.slots;
                    if (u != n.out || h != e.setup) {
                        var f = this.frames;
                        if (o < f[0])
                            h == e.setup && t.Utils.arrayCopy(r.slots, 0, r.drawOrder, 0, r.slots.length);
                        else {
                            var d = 0;
                            d = o >= f[f.length - 1] ? f.length - 1 : i.binarySearch(f, o) - 1;
                        ...
                        t.Utils.arrayCopy(r.slots, 0, r.drawOrder, 0, r.slots.length)
                }
                ,
                a
        }();
        ...
        var v = function(a) {
            ...
            return __extends(o, a),
                ...
                o.prototype.setFrame = function(t, e, n, r) {
                    t *= o.ENTRIES,
                        this.frames[t] = e,
                        this.frames[t + o.MIX] = n,
                        this.frames[t + o.BEND_DIRECTION] = r
                }
                ,
                o.prototype.apply = function(t, r, a, s, l, h, u) {
                    var c = this.frames
                        ...
                        switch (h) {
                            case e.setup:
                                return p.mix = p.data.mix,
                                    void (p.bendDirection = p.data.bendDirection);
                            case e.current:
                                p.mix += (p.data.mix - p.mix) * l,
                                    p.bendDirection = p.data.bendDirection
                        }
                    else if (a >= c[c.length - o.ENTRIES])
                        h == e.setup ? (p.mix = p.data.mix + (c[c.length + o.PREV_MIX] - p.data.mix) * l,
                            p.bendDirection = u == n.out ? p.data.bendDirection : c[c.length + o.PREV_BEND_DIRECTION]) : (p.mix += (c[c.length + o.PREV_MIX] - p.mix) * l,
                        u == n.in && (p.bendDirection = c[c.length + o.PREV_BEND_DIRECTION]));
                    else {
                        var f = i.binarySearch(c, a, o.ENTRIES)
                            , d = c[f + o.PREV_MIX]
                            , m = c[f]
                            , g = this.getCurvePercent(f / o.ENTRIES - 1, 1 - (a - m) / (c[f + o.PREV_TIME] - m));
                        h == e.setup ? (p.mix = p.data.mix + (d + (c[f + o.MIX] - d) * g - p.data.mix) * l,
                            p.bendDirection = u == n.out ? p.data.bendDirection : c[f + o.PREV_BEND_DIRECTION]) : (p.mix += (d + (c[f + o.MIX] - d) * g - p.mix) * l,
                        u == n.in && (p.bendDirection = c[f + o.PREV_BEND_DIRECTION]))
                    }
                }
                ,
                o.ENTRIES = 3,
        ...
        var y = function(n) {
            ...
            return __extends(a, n),
                ...
                a.prototype.setFrame = function(t, e, n, r, i, o) {
                    t *= a.ENTRIES,
                        this.frames[t] = e,
                        this.frames[t + a.ROTATE] = n,
                        this.frames[t + a.TRANSLATE] = r,
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < u[0]) {
                        ...
                        switch (l) {
                            ...
                            case e.current:
                                c.rotateMix += (p.rotateMix - c.rotateMix) * s,
                                    c.translateMix += (p.translateMix - c.translateMix) * s,
                                    c.scaleMix += (p.scaleMix - c.scaleMix) * s,
                                    c.shearMix += (p.shearMix - c.shearMix) * s
                        }
                    } else {
                        var f = 0
                            , d = 0
                        ...
                        if (r >= u[u.length - a.ENTRIES]) {
                            var v = u.length;
                            f = u[v + a.PREV_ROTATE],
                                d = u[v + a.PREV_TRANSLATE],
                                m = u[v + a.PREV_SCALE],
                                g = u[v + a.PREV_SHEAR]
                        } else {
                            var y = i.binarySearch(u, r, a.ENTRIES);
                            f = u[y + a.PREV_ROTATE],
                                d = u[y + a.PREV_TRANSLATE],
                                m = u[y + a.PREV_SCALE],
                                g = u[y + a.PREV_SHEAR];
                            var x = u[y]
                                , M = this.getCurvePercent(y / a.ENTRIES - 1, 1 - (r - x) / (u[y + a.PREV_TIME] - x));
                            f += (u[y + a.ROTATE] - f) * M,
                                d += (u[y + a.TRANSLATE] - d) * M,
                                m += (u[y + a.SCALE] - m) * M,
                                g += (u[y + a.SHEAR] - g) * M
                        }
                        if (l == e.setup) {
                            p = c.data;
                            c.rotateMix = p.rotateMix + (f - p.rotateMix) * s,
                                c.translateMix = p.translateMix + (d - p.translateMix) * s,
                                c.scaleMix = p.scaleMix + (m - p.scaleMix) * s,
                                c.shearMix = p.shearMix + (g - p.shearMix) * s
                        } else
                            c.rotateMix += (f - c.rotateMix) * s,
                                c.translateMix += (d - c.translateMix) * s,
                                c.scaleMix += (m - c.scaleMix) * s,
                                c.shearMix += (g - c.shearMix) * s
                    }
                }
                ,
                a.ENTRIES = 5,
            ...
            return __extends(a, n),
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < u[0])
                        ...
                        var p = 0;
                        if (r >= u[u.length - a.ENTRIES])
                            p = u[u.length + a.PREV_VALUE];
                        else {
                            var f = i.binarySearch(u, r, a.ENTRIES);
                            p = u[f + a.PREV_VALUE];
                            var d = u[f]
                                , m = this.getCurvePercent(f / a.ENTRIES - 1, 1 - (r - d) / (u[f + a.PREV_TIME] - d));
                            p += (u[f + a.VALUE] - p) * m
                        }
            ...
            return __extends(n, t),
                ...
                n.prototype.apply = function(t, r, a, o, s, l, h) {
                    ...
                    if (a < u[0])
                        ...
                        var p = 0;
                        if (a >= u[u.length - n.ENTRIES])
                            p = u[u.length + n.PREV_VALUE];
                        else {
                            var f = i.binarySearch(u, a, n.ENTRIES);
                            p = u[f + n.PREV_VALUE];
                            var d = u[f]
                                , m = this.getCurvePercent(f / n.ENTRIES - 1, 1 - (a - d) / (u[f + n.PREV_TIME] - d));
                            p += (u[f + n.VALUE] - p) * m
                        }
                ...
                a.prototype.apply = function(t, n, r, o, s, l, h) {
                    ...
                    if (r < u[0])
                        switch (l) {
                            ...
                            case e.current:
                                c.rotateMix += (c.data.rotateMix - c.rotateMix) * s,
                                    c.translateMix += (c.data.translateMix - c.translateMix) * s
                        }
                    else {
                        var p = 0
                            , f = 0;
                        if (r >= u[u.length - a.ENTRIES])
                            p = u[u.length + a.PREV_ROTATE],
                                f = u[u.length + a.PREV_TRANSLATE];
                        else {
                            var d = i.binarySearch(u, r, a.ENTRIES);
                            p = u[d + a.PREV_ROTATE],
                                f = u[d + a.PREV_TRANSLATE];
                            var m = u[d]
                                , g = this.getCurvePercent(d / a.ENTRIES - 1, 1 - (r - m) / (u[d + a.PREV_TIME] - m));
                            p += (u[d + a.ROTATE] - p) * g,
                                f += (u[d + a.TRANSLATE] - f) * g
                        }
                        l == e.setup ? (c.rotateMix = c.data.rotateMix + (p - c.data.rotateMix) * s,
                            c.translateMix = c.data.translateMix + (f - c.data.translateMix) * s) : (c.rotateMix += (p - c.rotateMix) * s,
        ...
        !function(t) {
            var e = function() {
                ...
                return e.prototype.update = function(t) {
                    ...
                    for (var e = this.tracks, n = 0, r = e.length; n < r; n++) {
                        ...
                        if (null != i) {
                            ...
                            if (null != o) {
                                ...
                                if (s >= 0) {
                                    for (o.delay = 0,
                                             o.trackTime = s + t * o.timeScale,
                                             i.trackTime += a,
                                             this.setCurrent(n, o, !0); null != o.mixingFrom; )
                                        o.mixTime += a,
                                            o = o.mixingFrom;
                                    continue
                                }
                    ...
                    e.prototype.updateMixingFrom = function(t, e) {
                        ...
                        return t.mixTime > 0 && (t.mixTime >= t.mixDuration || 0 == t.timeScale) ? (0 == n.totalAlpha && (t.mixingFrom = n.mixingFrom,
                            t.interruptAlpha = n.interruptAlpha,
                            this.queue.end(n)),
                            r) : (n.animationLast = n.nextAnimationLast,
                            n.trackLast = n.nextTrackLast,
                            n.trackTime += e * n.timeScale,
                            t.mixTime += e * t.timeScale,
                            !1)
                    }
                    ,
                    e.prototype.apply = function(n) {
                        ...
                        for (var r = this.events, i = this.tracks, a = !1, o = 0, s = i.length; o < s; o++) {
                            ...
                            if (!(null == l || l.delay > 0)) {
                                ...
                                if (1 == u)
                                    for (var m = 0; m < f; m++)
                                        d[m].apply(n, c, p, r, 1, t.MixPose.setup, t.MixDirection.in);
                                else {
                                    ...
                                    for (m = 0; m < f; m++) {
                                        ...
                                        x instanceof t.RotateTimeline ? this.applyRotateTimeline(x, n, p, u, M, y, m << 1, v) : (t.Utils.webkit602BugfixHelper(u, M),
                                            x.apply(n, c, p, r, u, M, t.MixDirection.in))
                                    }
                                }
                    ...
                    e.prototype.applyMixingFrom = function(n, r, i) {
                        ...
                        var o = 0;
                        0 == n.mixDuration ? (o = 1,
                            i = t.MixPose.setup) : (o = n.mixTime / n.mixDuration) > 1 && (o = 1);
                        ...
                        var v, y = a.timelinesRotation, x = a.alpha * n.interruptAlpha, M = x * (1 - o), w = 0;
                        a.totalAlpha = 0;
                        for (var E = 0; E < p; E++) {
                            var T = f[E];
                            switch (d[E]) {
                                case e.SUBSEQUENT:
                                    if (!l && T instanceof t.AttachmentTimeline)
                                        continue;
                                    if (!h && T instanceof t.DrawOrderTimeline)
                                        continue;
                                    v = i,
                                        w = M;
                                    break;
                            ...
                            a.totalAlpha += w,
                                T instanceof t.RotateTimeline ? this.applyRotateTimeline(T, r, c, w, v, y, E << 1, g) : T.apply(r, u, c, s, w, v, t.MixDirection.out)
                        }
                        return n.mixDuration > 0 && this.queueEvents(a, c),
                            this.events.length = 0,
                            a.nextAnimationLast = c,
                    ...
                    e.prototype.applyRotateTimeline = function(e, n, r, i, a, o, s, l) {
                        ...
                        1 != i) {
                            ...
                            if (r < u[0])
                                a == t.MixPose.setup && (c.rotation = c.data.rotation);
                            else {
                                var p = 0;
                                if (r >= u[u.length - t.RotateTimeline.ENTRIES])
                                    p = c.data.rotation + u[u.length + t.RotateTimeline.PREV_ROTATION];
                                else {
                                    ...
                                    p = u[f + t.RotateTimeline.ROTATION] - d,
                                        p = d + (p -= 360 * (16384 - (16384.499999999996 - p / 360 | 0))) * g + c.data.rotation,
                                        p -= 360 * (16384 - (16384.499999999996 - p / 360 | 0))
                                }
                                ...
                                if (0 == x)
                                    ...
                                    var E = x > 0
                                        , T = M >= 0;
                                    t.MathUtils.signum(w) != t.MathUtils.signum(x) && Math.abs(w) <= 90 && (Math.abs(M) > 180 && (M += 360 * t.MathUtils.signum(M)),
                                        T = E),
                                        y = x + M - M % 360,
                                    T != E && (y += 360 * t.MathUtils.signum(M)),
                                        o[s] = y
                                }
                                o[s + 1] = x,
                                    v += y * i,
                                    c.rotation = v - 360 * (16384 - (16384.499999999996 - v / 360 | 0))
                            }
                        } else
                            e.apply(n, 0, r, null, 1, a, t.MixDirection.in)
                    }
                    ,
                    ...
                    e.prototype.addAnimationWith = function(t, e, n, r) {
                        ...
                        var a = this.trackEntry(t, e, n, i);
                        if (null == i)
                            this.setCurrent(t, a, !0),
                                this.queue.drain();
                        else if (i.next = a,
                        r <= 0) {
                            var o = i.animationEnd - i.animationStart;
                            0 != o ? (i.loop ? r += o * (1 + (i.trackTime / o | 0)) : r += o,
                                r -= this.data.getMix(i.animation, e)) : r = 0
                        }
                        return a.delay = r,
                            a
                    }
                    ...
                    e.prototype.expandToIndex = function(e) {
                        return e < this.tracks.length ? this.tracks[e] : (t.Utils.ensureArrayCapacity(this.tracks, e - this.tracks.length + 1, null),
                    ...
                    e.prototype.hasAnimationByName = function(t) {
                        return e.deprecatedWarning3 || (e.deprecatedWarning3 = !0,
            ...
            var n = function() {
                ...
                return n.prototype.reset = function() {
                    ...
                    ,
                    n.deprecatedWarning1 = !1,
                    n.deprecatedWarning2 = !1,
                    n
            }();
            t.TrackEntry = n;
            var r, i = function() {
                ...
                return e.prototype.start = function(t) {
                    ...
                    e.prototype.deprecateStuff = function() {
                        return e.deprecatedWarning1 || (e.deprecatedWarning1 = !0,
                    ...
                    e.prototype.drain = function() {
                        if (!this.drainDisabled) {
                            ...
                            for (var e = this.objects, n = this.animState.listeners, i = 0; i < e.length; i += 2) {
                                var a = e[i]
                                    , o = e[i + 1];
                                switch (a) {
                                    case r.start:
                                        ...
                                        for (var s = 0; s < n.length; s++)
                                            n[s].start && n[s].start(o);
                                        o.onStart && this.deprecateStuff() && o.onStart(o.trackIndex),
                                        this.animState.onStart && this.deprecateStuff() && this.deprecateStuff && this.animState.onStart(o.trackIndex);
                                        break;
                                    case r.interrupt:
                                        null != o.listener && o.listener.interrupt && o.listener.interrupt(o);
                                        for (s = 0; s < n.length; s++)
                                            n[s].interrupt && n[s].interrupt(o);
                                        break;
                                    case r.end:
                                        null != o.listener && o.listener.end && o.listener.end(o);
                                        for (s = 0; s < n.length; s++)
                                            n[s].end && n[s].end(o);
                                        o.onEnd && this.deprecateStuff() && o.onEnd(o.trackIndex),
                                        this.animState.onEnd && this.deprecateStuff() && this.animState.onEnd(o.trackIndex);
                                    case r.dispose:
                                        null != o.listener && o.listener.dispose && o.listener.dispose(o);
                                        for (s = 0; s < n.length; s++)
                                            n[s].dispose && n[s].dispose(o);
                                        this.animState.trackEntryPool.free(o);
                                        break;
                                    case r.complete:
                                        null != o.listener && o.listener.complete && o.listener.complete(o);
                                        for (s = 0; s < n.length; s++)
                                            n[s].complete && n[s].complete(o);
                                        var l = t.MathUtils.toInt(o.loopsCount());
                                        o.onComplete && this.deprecateStuff() && o.onComplete(o.trackIndex, l),
                                        this.animState.onComplete && this.deprecateStuff() && this.animState.onComplete(o.trackIndex, l);
                                        break;
                                    case r.event:
                                        var h = e[2 + i++];
                                        null != o.listener && o.listener.event && o.listener.event(o, h);
                                        for (s = 0; s < n.length; s++)
                                            n[s].event && n[s].event(o, h);
                                        o.onEvent && this.deprecateStuff() && o.onEvent(o.trackIndex, h),
                                        this.animState.onEvent && this.deprecateStuff() && this.animState.onEvent(o.trackIndex, h)
                                }
                            }
                            this.clear(),
                                this.drainDisabled = !1
            ...
            var e = function() {
                ...
                return t.prototype.setMix = function(t, e, n) {
                    ...
                    t.prototype.setMixByName = function(e, n, r) {
                        t.deprecatedWarning1 || (t.deprecatedWarning1 = !0,
        ...
        !function(t) {
            var e = function() {
                ...
                return e.prototype.newRegionAttachment = function(e, n, r) {
                    ...
                    if (null == i)
                        throw new Error("Region not found in atlas: " + r + " (region attachment: " + n + ")");
                    ...
                    e.prototype.newMeshAttachment = function(e, n, r) {
                        var i = this.atlas.findRegion(r);
                        if (null == i)
                            throw new Error("Region not found in atlas: " + r + " (mesh attachment: " + n + ")");
    ...
    function(t) {
        !function(t) {
            var e = function() {
                function e(t, e, n) {
                    if (this.matrix = new PIXI.Matrix,
                ...
                return Object.defineProperty(e.prototype, "worldX", {
                    ...
                    e.prototype.updateWorldTransformWith = function(n, r, i, a, o, s, l) {
                        ...
                        var v = h.matrix.a
                            ...
                            , x = h.matrix.b
                            , M = h.matrix.d;
                        switch (u.tx = v * n + y * r + h.matrix.tx,
                            u.ty = x * n + M * r + h.matrix.ty,
                            ...
                            case t.TransformMode.OnlyTranslation:
                                c = i + 90 + l;
                                u.a = t.MathUtils.cosDeg(i + s) * a,
                                    u.c = t.MathUtils.cosDeg(c) * o,
                                    u.b = t.MathUtils.sinDeg(i + s) * a,
                                    u.d = t.MathUtils.sinDeg(c) * o;
                                break;
                            case t.TransformMode.NoRotationOrReflection:
                                var w = 0;
                                (b = v * v + x * x) > 1e-4 ? (y = x * (b = Math.abs(v * M - y * x) / b),
                                    M = v * b,
                                    w = Math.atan2(x, v) * t.MathUtils.radDeg) : (v = 0,
                                    x = 0,
                                    w = 90 - Math.atan2(M, y) * t.MathUtils.radDeg);
                                var E = i + s - w
                                    , T = i + l - w + 90;
                                p = t.MathUtils.cosDeg(E) * a,
                                    f = t.MathUtils.cosDeg(T) * o,
                                    d = t.MathUtils.sinDeg(E) * a,
                                    m = t.MathUtils.sinDeg(T) * o;
                                u.a = v * p - y * d,
                                    u.c = v * f - y * m,
                                    u.b = x * p + M * d,
                                    u.d = x * f + M * m;
                            ...
                            case t.TransformMode.NoScaleOrReflection:
                                var b, A = t.MathUtils.cosDeg(i), I = t.MathUtils.sinDeg(i), S = v * A + y * I, R = x * A + M * I;
                                (b = Math.sqrt(S * S + R * R)) > 1e-5 && (b = 1 / b),
                                    S *= b,
                                    R *= b,
                                    b = Math.sqrt(S * S + R * R);
                                ...
                                return u.a = S * p + C * d,
                                    ...
                                    u.b = R * p + _ * d,
                                    u.d = R * f + _ * m,
                                    void ((this.data.transformMode != t.TransformMode.NoScaleOrReflection ? v * M - y * x < 0 : this.skeleton.flipX != this.skeleton.flipY != e.yDown) && (u.c = -u.c,
                                        u.d = -u.d))
                        }
                        this.skeleton.flipX && (u.a = -u.a,
                            u.c = -u.c),
                        this.skeleton.flipY != e.yDown && (u.b = -u.b,
                            u.d = -u.d)
                    }
                    ,
                    ...
                    e.prototype.updateAppliedTransform = function() {
                        ...
                        if (null == e)
                            return this.ax = n.tx,
                                this.ay = n.ty,
                                this.arotation = Math.atan2(n.b, n.a) * t.MathUtils.radDeg,
                                this.ascaleX = Math.sqrt(n.a * n.a + n.b * n.b),
                                this.ascaleY = Math.sqrt(n.c * n.c + n.d * n.d),
                                this.ashearX = 0,
                                void (this.ashearY = Math.atan2(n.a * n.c + n.b * n.d, n.a * n.d - n.b * n.c) * t.MathUtils.radDeg);
                        var r = e.matrix
                            , i = 1 / (r.a * r.d - r.b * r.c)
                            , a = n.tx - r.tx
                            , o = n.ty - r.ty;
                        this.ax = a * r.d * i - o * r.c * i,
                            this.ay = o * r.a * i - a * r.b * i;
                        var s = i * r.d
                            , l = i * r.a
                            , h = i * r.c
                            , u = i * r.b
                            ...
                            , d = l * n.d - u * n.c;
                        if (this.ashearX = 0,
                            this.ascaleX = Math.sqrt(c * c + f * f),
                        this.ascaleX > 1e-4) {
                            var m = c * d - p * f;
                            this.ascaleY = m / this.ascaleX,
                                this.ashearY = Math.atan2(c * p + f * d, m) * t.MathUtils.radDeg,
                                this.arotation = Math.atan2(f, c) * t.MathUtils.radDeg
                        } else
                            this.ascaleX = 0,
                                this.ascaleY = Math.sqrt(p * p + d * d),
                                this.ashearY = 0,
                                this.arotation = 90 - Math.atan2(d, p) * t.MathUtils.radDeg
                    }
                    ,
                    ...
                    e.prototype.apply2 = function(e, n, r, i, a, o) {
                        if (0 != o) {
                            ...
                            var I = 1 / (M * (T = A.d) - w * E)
                                ...
                                , X = 0;
                            t: if (b) {
                                var U = (P * P + C * C - k * k - (N *= h) * N) / (2 * k * N);
                                U < -1 ? U = -1 : U > 1 && (U = 1),
                                    X = Math.acos(U) * a,
                                    M = k + N * U,
                                    w = N * Math.sin(X),
                                    D = Math.atan2(C * M - P * w, P * M + C * w)
                            } else {
                                var O = (M = h * N) * M
                                    , Y = (w = u * N) * w
                                    , F = P * P + C * C
                                    ...
                                    , B = -2 * Y * k
                                    , W = Y - O;
                                if ((T = B * B - 4 * W * (E = Y * k * k + O * F - O * Y)) >= 0) {
                                    var q = Math.sqrt(T);
                                    B < 0 && (q = -q);
                                    var j = (q = -(B + q) / 2) / W
                                        , G = E / q
                                    ...
                                    if (z * z <= F) {
                                        R = Math.sqrt(F - z * z) * a,
                                            D = L - Math.atan2(R, z),
                                            X = Math.atan2(R / u, (z - k) / h);
                                        break t
                                    }
                                }
                                var H = t.MathUtils.PI
                                    , Z = k - M
                                    , J = Z * Z
                                    , Q = 0
                                    , K = 0
                                    ...
                                    , tt = $ * $
                                    , et = 0;
                                (E = -M * k / (O - Y)) >= -1 && E <= 1 && (E = Math.acos(E),
                                (T = (S = M * Math.cos(E) + k) * S + (R = w * Math.sin(E)) * R) < J && (H = E,
                                    J = T,
                                    Z = S,
                                    Q = R),
                                T > tt && (K = E,
                                    ...
                                    $ = S,
                                    et = R)),
                                    F <= (J + tt) / 2 ? (D = L - Math.atan2(Q * a, Z),
                                        X = H * a) : (D = L - Math.atan2(et * a, $),
                                        X = K * a)
                            }
                            var nt = Math.atan2(v, g) * m
                                , rt = e.arotation;
                            (D = (D - nt) * t.MathUtils.radDeg + f - rt) > 180 ? D -= 360 : D < -180 && (D += 360),
                                e.updateWorldTransformWith(s, l, rt + D * o, e.ascaleX, e.ascaleY, 0, 0),
                                rt = n.arotation,
                                (X = ((X + nt) * t.MathUtils.radDeg - n.ashearX) * m + d - rt) > 180 ? X -= 360 : X < -180 && (X += 360),
                                n.updateWorldTransformWith(g, v, rt + X * o, n.ascaleX, n.ascaleY, n.ashearX, n.ashearY)
                        } else
                ...
                return e.prototype.apply = function() {
                        ...
                        if (n instanceof t.PathAttachment) {
                            ...
                            if (i > 0 || a) {
                                ...
                                if (c || l) {
                                    ...
                                    for (y = 1; y < f; y++)
                                        m[y] = v;
                                var b = this.computeWorldPositions(n, f, u, o.positionMode == t.PositionMode.Percent, s == t.SpacingMode.Percent)
                                    , A = b[0]
                                    , I = b[1]
                                    , S = o.offsetRotation
                                    , R = !1;
                                if (0 == S)
                                    R = h == t.RotateMode.Chain;
                                else
                                    R = !1,
                                        S *= (P = this.target.bone.matrix).a * P.d - P.b * P.c > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad;
                                y = 0;
                                for (var P = 3; y < p; y++,
                                    P += 3) {
                                    var C, _ = (C = d[y]).matrix;
                                    _.tx += (A - _.tx) * i,
                                        _.ty += (I - _.ty) * i;
                                    var V = (w = b[P]) - A
                                        , k = (E = b[P + 1]) - I;
                                    if (c) {
                                        var N = g[y];
                                        if (0 != N) {
                                            var D = (Math.sqrt(V * V + k * k) / N - 1) * r + 1;
                                            _.a *= D,
                                                _.b *= D
                                        }
                                    }
                                    if (A = w,
                                        ...
                                        var X = _.a
                                            ...
                                            , L = 0
                                            , B = 0;
                                        if (F = u ? b[P - 1] : 0 == m[y + 1] ? b[P + 2] : Math.atan2(k, V),
                                            F -= Math.atan2(O, X),
                                            R) {
                                            L = Math.cos(F),
                                                B = Math.sin(F);
                                            ...
                                            F += S;
                                        F > t.MathUtils.PI ? F -= t.MathUtils.PI2 : F < -t.MathUtils.PI && (F += t.MathUtils.PI2),
                                            F *= r,
                                            L = Math.cos(F),
                                            B = Math.sin(F),
                                            _.a = L * X - B * O,
                    ...
                    e.prototype.computeWorldPositions = function(n, r, i, a, o) {
                        ...
                        if (!n.constantSpeed) {
                            ...
                            for (var x = 0, M = 0; y < r; y++,
                                ...
                                if (p)
                                    ...
                                    if (w < 0) {
                                        m != e.BEFORE && (m = e.BEFORE,
                                            n.computeWorldVertices(s, 2, 4, c, 0, 2)),
                                            this.addBeforePosition(w, c, 0, u, x);
                                        continue
                                    }
                                    if (w > v) {
                                        m != e.AFTER && (m = e.AFTER,
                                            n.computeWorldVertices(s, f - 6, 4, c, 0, 2)),
                                            this.addAfterPosition(w - v, c, 0, u, x);
                                        continue
                                    }
                                }
                                for (; ; M++) {
                                ...
                                M != m && (m = M,
                                    p && M == d ? (n.computeWorldVertices(s, f - 4, 4, c, 0, 2),
                                        n.computeWorldVertices(s, 0, 4, c, 4, 2)) : n.computeWorldVertices(s, 6 * M + 2, 8, c, 0, 2)),
                                    this.addCurvePosition(w, c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], u, x, i || y > 0 && 0 == j)
                            }
                            return u
                        }
                        p ? (f += 2,
                            c = t.Utils.setArraySize(this.world, f),
                            n.computeWorldVertices(s, 2, f - 4, c, 0, 2),
                            n.computeWorldVertices(s, 0, 2, c, f - 4, 2),
                            c[f - 2] = c[0],
                            c[f - 1] = c[1]) : (d--,
                            f -= 4,
                            c = t.Utils.setArraySize(this.world, f),
                            n.computeWorldVertices(s, 2, f, c, 0, 2));
                        for (var T = t.Utils.setArraySize(this.curves, d), b = 0, A = c[0], I = c[1], S = 0, R = 0, P = 0, C = 0, _ = 0, V = 0, k = 0, N = 0, D = 0, X = 0, U = 0, O = 0, Y = 0, F = 0, L = (y = 0,
                            2); y < d; y++,
                                 L += 6)
                            S = c[L],
                                R = c[L + 1],
                                P = c[L + 2],
                                C = c[L + 3],
                                U = 2 * (k = .1875 * (A - 2 * S + P)) + (D = .09375 * (3 * (S - P) - A + (_ = c[L + 4]))),
                                O = 2 * (N = .1875 * (I - 2 * R + C)) + (X = .09375 * (3 * (R - C) - I + (V = c[L + 5]))),
                                Y = .75 * (S - A) + k + .16666667 * D,
                                F = .75 * (R - I) + N + .16666667 * X,
                                b += Math.sqrt(Y * Y + F * F),
                                Y += U,
                                F += O,
                                U += D,
                        ...
                        if (a && (l *= b),
                            ...
                            for (y = 0; y < r; y++)
                                h[y] *= b;
                        for (var B = this.segments, W = 0, q = (y = 0,
                            x = 0,
                            M = 0,
                            0); y < r; y++,
                                 x += 3) {
                            ...
                            if (p)
                                ...
                                if (w > b) {
                                    this.addAfterPosition(w - b, c, f - 4, u, x);
                                    continue
                                }
                            }
                            for (; ; M++) {
                            ...
                            if (M != m) {
                                ...
                                for (A = c[z],
                                         ...
                                         P = c[z + 4],
                                         C = c[z + 5],
                                         U = 2 * (k = .03 * (A - 2 * S + P)) + (D = .006 * (3 * (S - P) - A + (_ = c[z + 6]))),
                                         O = 2 * (N = .03 * (I - 2 * R + C)) + (X = .006 * (3 * (R - C) - I + (V = c[z + 7]))),
                                         Y = .3 * (S - A) + k + .16666667 * D,
                                         F = .3 * (R - I) + N + .16666667 * X,
                                         W = Math.sqrt(Y * Y + F * F),
                                         B[0] = W,
                                         z = 1; z < 8; z++)
                                    Y += U,
                            ...
                            this.addCurvePosition(.1 * w, A, I, S, R, P, C, _, V, u, x, i || y > 0 && 0 == j)
                        }
                        return u
                    }
                    ,
                    ...
                    e.prototype.addCurvePosition = function(t, e, n, r, i, a, o, s, l, h, u, c) {
                        ...
                        h[u] = w,
                            h[u + 1] = E,
                        c && (h[u + 2] = Math.atan2(E - (n * m + i * v * 2 + o * p), w - (e * m + r * v * 2 + a * p)))
                    }
                    ,
        ...
        !function(t) {
            var e = function() {
                function e(e) {
                    ...
                    for (var n = 0; n < e.bones.length; n++) {
                        var r = e.bones[n]
                            , i = void 0;
                        if (null == r.parent)
                            i = new t.Bone(r,this,null);
                        else {
                            var a = this.bones[r.parent.index];
                            i = new t.Bone(r,this,a),
                                a.children.push(i)
                        }
                        this.bones.push(i)
                    }
                    ...
                    for (n = 0; n < e.slots.length; n++) {
                        var o = e.slots[n]
                            , s = (i = this.bones[o.boneData.index],
                            new t.Slot(o,i));
                        this.slots.push(s),
                            this.drawOrder.push(s)
                    }
                ...
                return e.prototype.updateCache = function() {
                    ...
                    t: for (e = 0; e < h; e++) {
                        for (var u = 0; u < o; u++) {
                            if ((c = r[u]).data.order == e) {
                                this.sortIkConstraint(c);
                                continue t
                            }
                        }
                        for (u = 0; u < s; u++) {
                            if ((c = i[u]).data.order == e) {
                    ...
                    e.prototype.sortPathConstraint = function(e) {
                        var n = e.target
                            , r = n.data.index
                            , i = n.bone;
                        null != this.skin && this.sortPathConstraintAttachment(this.skin, r, i),
                        null != this.data.defaultSkin && this.data.defaultSkin != this.skin && this.sortPathConstraintAttachment(this.data.defaultSkin, r, i);
                        for (var a = 0, o = this.data.skins.length; a < o; a++)
                            this.sortPathConstraintAttachment(this.data.skins[a], r, i);
                    ...
                    e.prototype.sortPathConstraintAttachment = function(t, e, n) {
                        ...
                        if (r)
                            for (var i in r)
                                this.sortPathConstraintAttachmentWith(r[i], n)
                    }
                    ,
                    ...
                    e.prototype.setBonesToSetupPose = function() {
                        ...
                        for (e = 0,
                                 n = r.length; e < n; e++) {
                            (s = r[e]).bendDirection = s.data.bendDirection,
                                s.mix = s.data.mix
                        }
                        ...
                        for (e = 0,
                                 n = i.length; e < n; e++) {
                            var a = (s = i[e]).data;
                            s.rotateMix = a.rotateMix,
                                s.translateMix = a.translateMix,
                                s.scaleMix = a.scaleMix,
                                s.shearMix = a.shearMix
                        }
                    ...
                    e.prototype.setAttachment = function(t, e) {
                        ...
                        for (var n = this.slots, r = 0, i = n.length; r < i; r++) {
                            ...
                            if (a.data.name == t) {
                                var o = null;
                                if (null != e && null == (o = this.getAttachment(r, e)))
                    ...
                    e.prototype.getBounds = function(e, n, r) {
                        ...
                        for (var i = this.drawOrder, a = Number.POSITIVE_INFINITY, o = Number.POSITIVE_INFINITY, s = Number.NEGATIVE_INFINITY, l = Number.NEGATIVE_INFINITY, h = 0, u = i.length; h < u; h++) {
                            var c = i[h]
                                ...
                                , f = null
                                , d = c.getAttachment();
                            if (d instanceof t.RegionAttachment)
                                p = 8,
                                    f = t.Utils.setArraySize(r, p, 0),
                                    d.computeWorldVertices(c.bone, f, 0, 2);
                            else if (d instanceof t.MeshAttachment) {
                                var m = d;
                                p = m.worldVerticesLength,
                                    f = t.Utils.setArraySize(r, p, 0),
                                    m.computeWorldVertices(c, 0, p, f, 0, 2)
                            }
                            if (null != f)
                ...
                return e.prototype.update = function(e, n) {
                    ...
                    for (var l = 0; l < s; l++) {
                        ...
                        if (u instanceof t.BoundingBoxAttachment) {
                            ...
                            p.length != c.worldVerticesLength && (p = t.Utils.newFloatArray(c.worldVerticesLength)),
                                i.push(p),
                                c.computeWorldVertices(h, 0, c.worldVerticesLength, p, 0, 2)
                        }
                    }
                    ...
                    e.prototype.aabbIntersectsSegment = function(t, e, n, r) {
                        var i = this.minX
                            ...
                            , o = this.maxX
                            , s = this.maxY;
                        if (t <= i && n <= i || e <= a && r <= a || t >= o && n >= o || e >= s && r >= s)
                            return !1;
                        var l = (r - e) / (n - t)
                            , h = l * (i - t) + e;
                        if (h > a && h < s)
                    ...
                    e.prototype.intersectsSegment = function(t, e, n, r) {
                        for (var i = this.polygons, a = 0, o = i.length; a < o; a++)
                            if (this.intersectsSegmentPolygon(i[a], t, e, n, r))
                    ...
                    e.prototype.intersectsSegmentPolygon = function(t, e, n, r, i) {
                        for (var a = t, o = t.length, s = e - r, l = n - i, h = e * i - n * r, u = a[o - 2], c = a[o - 1], p = 0; p < o; p += 2) {
                            var f = a[p]
                                ...
                                , y = s * v - l * g
                                , x = (h * g - s * m) / y;
                            if ((x >= u && x <= f || x >= f && x <= u) && (x >= e && x <= r || x >= r && x <= e)) {
                                var M = (h * v - l * m) / y;
                                if ((M >= c && M <= d || M >= d && M <= c) && (M >= n && M <= i || M >= i && M <= n))
                                    return !0
                            }
                            u = f,
                                c = d
                ...
                return e.prototype.clipStart = function(n, r) {
                    ...
                    e.prototype.clipTriangles = function(e, n, r, i, a, o, s, l) {
                        ...
                        t: for (var g = 0; g < i; g += 3)
                            for (var v = r[g] << 1, y = e[v], x = e[v + 1], M = a[v], w = a[v + 1], E = e[v = r[g + 1] << 1], T = e[v + 1], b = a[v], A = a[v + 1], I = e[v = r[g + 2] << 1], S = e[v + 1], R = a[v], P = a[v + 1], C = 0; C < f; C++) {
                                var _ = u.length;
                                if (!this.clip(y, x, E, T, I, S, p[C], h)) {
                                    (F = t.Utils.setArraySize(u, _ + 3 * d))[_] = y,
                                        F[_ + 1] = x,
                                        F[_ + 2] = o.r,
                                        F[_ + 3] = o.g,
                                        F[_ + 4] = o.b,
                                        ...
                                        l ? (F[_ + 6] = M,
                                            ...
                                            F[_ + 23] = P),
                                        _ = c.length,
                                        (Z = t.Utils.setArraySize(c, _ + 3))[_] = m,
                                        Z[_ + 1] = m + 1,
                                        Z[_ + 2] = m + 2,
                                        m += 3;
                                    continue t
                                ...
                                var V = h.length;
                                if (0 != V) {
                                    for (var k = T - S, N = I - E, D = y - I, X = S - x, U = 1 / (k * D + N * (x - S)), O = V >> 1, Y = this.clipOutput, F = t.Utils.setArraySize(u, _ + O * d), L = 0; L < V; L += 2) {
                                        var B = Y[L]
                                            , W = Y[L + 1];
                                        F[_] = B,
                                            F[_ + 1] = W,
                                    ...
                                    _ = c.length;
                                    var Z = t.Utils.setArraySize(c, _ + 3 * (O - 2));
                                    O--;
                                    for (L = 1; L < O; L++)
                                        Z[_] = m,
                                            Z[_ + 1] = m + L,
                    ...
                    e.prototype.clip = function(t, e, n, r, i, a, o, s) {
                        ...
                        for (var c = o, p = o.length - 4, f = 0; ; f += 2) {
                            for (var d = c[f], m = c[f + 1], g = c[f + 2], v = c[f + 3], y = d - g, x = m - v, M = u, w = u.length - 2, E = s.length, T = 0; T < w; T += 2) {
                                var b = M[T]
                                    , A = M[T + 1]
                                    , I = M[T + 2]
                                    , S = M[T + 3]
                                ...
                                if (y * (A - v) - x * (b - g) > 0) {
                                    ...
                                    var P = ((_ = I - b) * (m - A) - (C = S - A) * (d - b)) / (C * (g - d) - _ * (v - m));
                                    s.push(d + (g - d) * P),
                                        s.push(m + (v - m) * P)
                                } else if (R) {
                                    var C, _;
                                    P = ((_ = I - b) * (m - A) - (C = S - A) * (d - b)) / (C * (g - d) - _ * (v - m));
                                    s.push(d + (g - d) * P),
                                        s.push(m + (v - m) * P),
                                        s.push(I),
                                        s.push(S)
                    ...
                    e.makeClockwise = function(t) {
                        for (var e = t, n = t.length, r = e[n - 2] * e[1] - e[0] * e[n - 1], i = 0, a = 0, o = 0, s = 0, l = n - 3; s < l; s += 2)
                            i = e[s],
                                a = e[s + 1],
                                o = e[s + 2],
                                r += i * e[s + 3] - o * a;
            ...
            var e = function() {
                ...
                return e.prototype.readSkeletonData = function(n) {
                    var r = this.scale
                        ...
                        , o = a.skeleton;
                    if (null != o && (i.hash = o.hash,
                        i.version = o.spine,
                        i.width = o.width,
                        i.height = o.height,
                        i.fps = o.fps,
                        i.imagesPath = o.images),
                        a.bones)
                        for (var s = 0; s < a.bones.length; s++) {
                            var l = a.bones[s]
                                , h = null
                                , u = this.getValue(l, "parent", null);
                            if (null != u && null == (h = i.findBone(u)))
                                throw new Error("Parent bone not found: " + u);
                            (d = new t.BoneData(i.bones.length,l.name,h)).length = this.getValue(l, "length", 0) * r,
                                d.x = this.getValue(l, "x", 0) * r,
                                d.y = this.getValue(l, "y", 0) * r,
                                d.rotation = this.getValue(l, "rotation", 0),
                                d.scaleX = this.getValue(l, "scaleX", 1),
                                d.scaleY = this.getValue(l, "scaleY", 1),
                                d.shearX = this.getValue(l, "shearX", 0),
                                d.shearY = this.getValue(l, "shearY", 0),
                                d.transformMode = e.transformModeFromString(this.getValue(l, "transform", "normal")),
                                i.bones.push(d)
                        }
                    if (a.slots)
                        for (s = 0; s < a.slots.length; s++) {
                            var c = (A = a.slots[s]).name
                                , p = A.bone
                                , f = i.findBone(p);
                            if (null == f)
                                throw new Error("Slot bone not found: " + p);
                            var d = new t.SlotData(i.slots.length,c,f)
                                , m = this.getValue(A, "color", null);
                            null != m && d.color.setFromString(m);
                            var g = this.getValue(A, "dark", null);
                            null != g && (d.darkColor = new t.Color(1,1,1,1),
                                d.darkColor.setFromString(g)),
                                d.attachmentName = this.getValue(A, "attachment", null),
                                d.blendMode = e.blendModeFromString(this.getValue(A, "blend", "normal")),
                                i.slots.push(d)
                        }
                    if (a.ik)
                        for (s = 0; s < a.ik.length; s++) {
                            var v = a.ik[s];
                            (d = new t.IkConstraintData(v.name)).order = this.getValue(v, "order", 0);
                            for (var y = 0; y < v.bones.length; y++) {
                                p = v.bones[y];
                                if (null == (M = i.findBone(p)))
                                    throw new Error("IK bone not found: " + p);
                                d.bones.push(M)
                            }
                            var x = v.target;
                            if (d.target = i.findBone(x),
                            null == d.target)
                                throw new Error("IK target bone not found: " + x);
                            d.bendDirection = this.getValue(v, "bendPositive", !0) ? 1 : -1,
                                d.mix = this.getValue(v, "mix", 1),
                                i.ikConstraints.push(d)
                        }
                    if (a.transform)
                        for (s = 0; s < a.transform.length; s++) {
                            v = a.transform[s];
                            (d = new t.TransformConstraintData(v.name)).order = this.getValue(v, "order", 0);
                            ...
                            if (d.target = i.findBone(x),
                            null == d.target)
                                throw new Error("Transform constraint target bone not found: " + x);
                            d.local = this.getValue(v, "local", !1),
                                d.relative = this.getValue(v, "relative", !1),
                                d.offsetRotation = this.getValue(v, "rotation", 0),
                                d.offsetX = this.getValue(v, "x", 0) * r,
                                d.offsetY = this.getValue(v, "y", 0) * r,
                                d.offsetScaleX = this.getValue(v, "scaleX", 0),
                                d.offsetScaleY = this.getValue(v, "scaleY", 0),
                                d.offsetShearY = this.getValue(v, "shearY", 0),
                                d.rotateMix = this.getValue(v, "rotateMix", 1),
                                d.translateMix = this.getValue(v, "translateMix", 1),
                                d.scaleMix = this.getValue(v, "scaleMix", 1),
                                d.shearMix = this.getValue(v, "shearMix", 1),
                                i.transformConstraints.push(d)
                        }
                    if (a.path)
                        for (s = 0; s < a.path.length; s++) {
                            v = a.path[s];
                            (d = new t.PathConstraintData(v.name)).order = this.getValue(v, "order", 0);
                            for (y = 0; y < v.bones.length; y++) {
                                var M;
                                p = v.bones[y];
                                if (null == (M = i.findBone(p)))
                            ...
                            x = v.target;
                            if (d.target = i.findSlot(x),
                            null == d.target)
                                throw new Error("Path target slot not found: " + x);
                            d.positionMode = e.positionModeFromString(this.getValue(v, "positionMode", "percent")),
                                d.spacingMode = e.spacingModeFromString(this.getValue(v, "spacingMode", "length")),
                                d.rotateMode = e.rotateModeFromString(this.getValue(v, "rotateMode", "tangent")),
                                d.offsetRotation = this.getValue(v, "rotation", 0),
                                d.position = this.getValue(v, "position", 0),
                            d.positionMode == t.PositionMode.Fixed && (d.position *= r),
                                d.spacing = this.getValue(v, "spacing", 0),
                            d.spacingMode != t.SpacingMode.Length && d.spacingMode != t.SpacingMode.Fixed || (d.spacing *= r),
                                d.rotateMix = this.getValue(v, "rotateMix", 1),
                                d.translateMix = this.getValue(v, "translateMix", 1),
                                i.pathConstraints.push(d)
                        }
                    if (a.skins)
                        for (var w in a.skins) {
                            var E = a.skins[w]
                                , T = new t.Skin(w);
                            for (var c in E) {
                                var b = i.findSlotIndex(c);
                                if (-1 == b)
                                    throw new Error("Slot not found: " + c);
                                var A = E[c];
                                for (var I in A) {
                                    var S = this.readAttachment(A[I], T, b, I, i);
                                    null != S && T.addAttachment(b, I, S)
                                }
                            }
                            i.skins.push(T),
                            "default" == T.name && (i.defaultSkin = T)
                        }
                    s = 0;
                    for (var R = this.linkedMeshes.length; s < R; s++) {
                        var P = this.linkedMeshes[s];
                        if (null == (T = null == P.skin ? i.defaultSkin : i.findSkin(P.skin)))
                            throw new Error("Skin not found: " + P.skin);
                        var C = T.getAttachment(P.slotIndex, P.parent);
                        if (null == C)
                    ...
                    if (this.linkedMeshes.length = 0,
                        ...
                        for (var _ in a.events) {
                            var V = a.events[_];
                            (d = new t.EventData(_)).intValue = this.getValue(V, "int", 0),
                                d.floatValue = this.getValue(V, "float", 0),
                                d.stringValue = this.getValue(V, "string", ""),
                                d.audio = this.getValue(V, "audio", null),
                                i.events.push(d)
                        }
                    if (a.animations)
                    ...
                    e.prototype.readAttachment = function(e, r, i, a, o) {
                        var s = this.scale;
                        switch (a = this.getValue(e, "name", a),
                            this.getValue(e, "type", "region")) {
                            case "region":
                                var l = this.getValue(e, "path", a)
                                    , h = this.attachmentLoader.newRegionAttachment(r, a, l);
                                return null == h ? null : (h.path = l,
                                    h.x = this.getValue(e, "x", 0) * s,
                                    h.y = this.getValue(e, "y", 0) * s,
                                    h.scaleX = this.getValue(e, "scaleX", 1),
                                    h.scaleY = this.getValue(e, "scaleY", 1),
                                    h.rotation = this.getValue(e, "rotation", 0),
                                    h.width = e.width * s,
                                    h.height = e.height * s,
                                null != (w = this.getValue(e, "color", null)) && h.color.setFromString(w),
                                    h);
                            case "boundingbox":
                                var u = this.attachmentLoader.newBoundingBoxAttachment(r, a);
                                return null == u ? null : (this.readVertices(e, u, e.vertexCount << 1),
                                null != (w = this.getValue(e, "color", null)) && u.color.setFromString(w),
                                    u);
                            case "mesh":
                            case "linkedmesh":
                                l = this.getValue(e, "path", a);
                                var c = this.attachmentLoader.newMeshAttachment(r, a, l);
                                if (null == c)
                                    return null;
                                c.path = l,
                                null != (w = this.getValue(e, "color", null)) && c.color.setFromString(w);
                                var p = this.getValue(e, "parent", null);
                                if (null != p)
                                    return c.inheritDeform = this.getValue(e, "deform", !0),
                                        this.linkedMeshes.push(new n(c,this.getValue(e, "skin", null),i,p)),
                                        c;
                                var f = e.uvs;
                                return this.readVertices(e, c, f.length),
                                    c.triangles = e.triangles,
                                    c.regionUVs = f,
                                    c.hullLength = 2 * this.getValue(e, "hull", 0),
                                    c;
                            case "path":
                                if (null == (l = this.attachmentLoader.newPathAttachment(r, a)))
                                    return null;
                                l.closed = this.getValue(e, "closed", !1),
                                    l.constantSpeed = this.getValue(e, "constantSpeed", !0);
                                var d = e.vertexCount;
                                this.readVertices(e, l, d << 1);
                                for (var m = t.Utils.newArray(d / 3, 0), g = 0; g < e.lengths.length; g++)
                                    m[g] = e.lengths[g] * s;
                                return l.lengths = m,
                                null != (w = this.getValue(e, "color", null)) && l.color.setFromString(w),
                                    l;
                            case "point":
                                var v = this.attachmentLoader.newPointAttachment(r, a);
                                return null == v ? null : (v.x = this.getValue(e, "x", 0) * s,
                                    v.y = this.getValue(e, "y", 0) * s,
                                    v.rotation = this.getValue(e, "rotation", 0),
                                null != (w = this.getValue(e, "color", null)) && v.color.setFromString(w),
                                    v);
                            case "clipping":
                                ...
                                var w;
                                d = e.vertexCount;
                                return this.readVertices(e, y, d << 1),
                                null != (w = this.getValue(e, "color", null)) && y.color.setFromString(w),
                                    y
                        }
                        return null
                    }
                    ...
                    e.prototype.readVertices = function(e, n, r) {
                        ...
                        if (r != a.length) {
                            ...
                            n.bones = s,
                                n.vertices = t.Utils.toFloatArray(o)
                        } else {
                    ...
                    e.prototype.readAnimation = function(e, n, r) {
                        ...
                        if (e.slots)
                            for (var s in e.slots) {
                                var l = e.slots[s];
                                if (-1 == (Z = r.findSlotIndex(s)))
                                    throw new Error("Slot not found: " + s);
                                for (var h in l) {
                                    var u = l[h];
                                    if ("attachment" == h) {
                                        (M = new t.AttachmentTimeline(u.length)).slotIndex = Z;
                                        for (var c = 0, p = 0; p < u.length; p++) {
                                            var f = u[p];
                                            M.setFrame(c++, f.time, f.name)
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[M.getFrameCount() - 1])
                                    } else if ("color" == h) {
                                        (M = new t.ColorTimeline(u.length)).slotIndex = Z;
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            var d = new t.Color;
                                            d.setFromString(f.color || "ffffffff"),
                                                M.setFrame(c, f.time, d.r, d.g, d.b, d.a),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.ColorTimeline.ENTRIES])
                                    } else {
                                        if ("twoColor" != h)
                                            throw new Error("Invalid timeline type for a slot: " + h + " (" + s + ")");
                                        (M = new t.TwoColorTimeline(u.length)).slotIndex = Z;
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            var m = new t.Color
                                                , g = new t.Color;
                                            m.setFromString(f.light),
                                                g.setFromString(f.dark),
                                                M.setFrame(c, f.time, m.r, m.g, m.b, m.a, g.r, g.g, g.b),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.TwoColorTimeline.ENTRIES])
                                    }
                                }
                            }
                        if (e.bones)
                                ...
                                for (var h in y) {
                                    ...
                                    if ("rotate" === h) {
                                        ...
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            M.setFrame(c, f.time, f.angle),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.RotateTimeline.ENTRIES])
                                    } else {
                                        if ("translate" !== h && "scale" !== h && "shear" !== h)
                                            throw new Error("Invalid timeline type for a bone: " + h + " (" + v + ")");
                                        var M = null
                                            , w = 1;
                                        "scale" === h ? M = new t.ScaleTimeline(u.length) : "shear" === h ? M = new t.ShearTimeline(u.length) : (M = new t.TranslateTimeline(u.length),
                                            w = i),
                                            M.boneIndex = x;
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            var E = this.getValue(f, "x", 0)
                                                , T = this.getValue(f, "y", 0);
                                            M.setFrame(c, f.time, E * w, T * w),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.TranslateTimeline.ENTRIES])
                                    }
                                }
                            }
                        if (e.ik)
                            for (var b in e.ik) {
                                var A = e.ik[b]
                                    , I = r.findIkConstraint(b);
                                (M = new t.IkConstraintTimeline(A.length)).ikConstraintIndex = r.ikConstraints.indexOf(I);
                                for (c = 0,
                                         p = 0; p < A.length; p++) {
                                    f = A[p];
                                    M.setFrame(c, f.time, this.getValue(f, "mix", 1), this.getValue(f, "bendPositive", !0) ? 1 : -1),
                                        this.readCurve(f, M, c),
                                        c++
                                }
                                a.push(M),
                                    o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.IkConstraintTimeline.ENTRIES])
                            }
                        if (e.transform)
                            for (var b in e.transform) {
                                A = e.transform[b],
                                    I = r.findTransformConstraint(b);
                                (M = new t.TransformConstraintTimeline(A.length)).transformConstraintIndex = r.transformConstraints.indexOf(I);
                                for (c = 0,
                                         p = 0; p < A.length; p++) {
                                    f = A[p];
                                    M.setFrame(c, f.time, this.getValue(f, "rotateMix", 1), this.getValue(f, "translateMix", 1), this.getValue(f, "scaleMix", 1), this.getValue(f, "shearMix", 1)),
                                        this.readCurve(f, M, c),
                                        c++
                                }
                                a.push(M),
                                    o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.TransformConstraintTimeline.ENTRIES])
                            }
                        if (e.paths)
                            for (var b in e.paths) {
                                A = e.paths[b];
                                var S = r.findPathConstraintIndex(b);
                                if (-1 == S)
                                    throw new Error("Path constraint not found: " + b);
                                var R = r.pathConstraints[S];
                                for (var h in A) {
                                    u = A[h];
                                    if ("position" === h || "spacing" === h) {
                                        M = null,
                                            w = 1;
                                        "spacing" === h ? (M = new t.PathConstraintSpacingTimeline(u.length),
                                        R.spacingMode != t.SpacingMode.Length && R.spacingMode != t.SpacingMode.Fixed || (w = i)) : (M = new t.PathConstraintPositionTimeline(u.length),
                                        R.positionMode == t.PositionMode.Fixed && (w = i)),
                                            M.pathConstraintIndex = S;
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            M.setFrame(c, f.time, this.getValue(f, h, 0) * w),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.PathConstraintPositionTimeline.ENTRIES])
                                    } else if ("mix" === h) {
                                        (M = new t.PathConstraintMixTimeline(u.length)).pathConstraintIndex = S;
                                        for (c = 0,
                                                 p = 0; p < u.length; p++) {
                                            f = u[p];
                                            M.setFrame(c, f.time, this.getValue(f, "rotateMix", 1), this.getValue(f, "translateMix", 1)),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                                            o = Math.max(o, M.frames[(M.getFrameCount() - 1) * t.PathConstraintMixTimeline.ENTRIES])
                                    }
                                }
                            }
                        if (e.deform)
                            for (var P in e.deform) {
                                var C = e.deform[P]
                                    , _ = r.findSkin(P);
                                if (null == _)
                                    throw new Error("Skin not found: " + P);
                                for (var s in C) {
                                    l = C[s];
                                    if (-1 == (Z = r.findSlotIndex(s)))
                                    ...
                                    for (var h in l) {
                                        u = l[h];
                                        var V = _.getAttachment(Z, h);
                                        if (null == V)
                                            throw new Error("Deform attachment not found: " + u.name);
                                        var k = null != V.bones
                                            , N = V.vertices
                                            , D = k ? N.length / 3 * 2 : N.length;
                                        (M = new t.DeformTimeline(u.length)).slotIndex = Z,
                                            M.attachment = V;
                                        c = 0;
                                        for (var X = 0; X < u.length; X++) {
                                            f = u[X];
                                            var U = void 0
                                                , O = this.getValue(f, "vertices", null);
                                            if (null == O)
                                                U = k ? t.Utils.newFloatArray(D) : N;
                                            else {
                                                U = t.Utils.newFloatArray(D);
                                                var Y = this.getValue(f, "offset", 0);
                                                if (t.Utils.arrayCopy(O, 0, U, Y, O.length),
                                                1 != i)
                                                    for (var F = (p = Y) + O.length; p < F; p++)
                                                        U[p] *= i;
                                                if (!k)
                                                    for (p = 0; p < D; p++)
                                                        U[p] += N[p]
                                            }
                                            M.setFrame(c, f.time, U),
                                                this.readCurve(f, M, c),
                                                c++
                                        }
                                        a.push(M),
                        ...
                        null != L) {
                            M = new t.DrawOrderTimeline(L.length);
                            var B = r.slots.length;
                            for (c = 0,
                                     X = 0; X < L.length; X++) {
                                var W = L[X]
                                    , q = null
                                    , j = this.getValue(W, "offsets", null);
                                if (null != j) {
                                    q = t.Utils.newArray(B, -1);
                                    var G = t.Utils.newArray(B - j.length, 0)
                                        , z = 0
                                        , H = 0;
                                    for (p = 0; p < j.length; p++) {
                                        var Z, J = j[p];
                                        if (-1 == (Z = r.findSlotIndex(J.slot)))
                                ...
                                M.setFrame(c++, W.time, q)
                            }
                            a.push(M),
                                o = Math.max(o, M.frames[M.getFrameCount() - 1])
                        }
                        if (e.events) {
                            for (M = new t.EventTimeline(e.events.length),
                                     c = 0,
                                     p = 0; p < e.events.length; p++) {
                                var Q = e.events[p]
                                    , K = r.findEvent(Q.name);
                                if (null == K)
                                    throw new Error("Event not found: " + Q.name);
                                var $ = new t.Event(t.Utils.toSinglePrecision(Q.time),K);
                                $.intValue = this.getValue(Q, "int", K.intValue),
                                    $.floatValue = this.getValue(Q, "float", K.floatValue),
                                    $.stringValue = this.getValue(Q, "string", K.stringValue),
                                    M.setFrame(c++, $)
                            }
                            a.push(M),
                                o = Math.max(o, M.frames[M.getFrameCount() - 1])
        ...
        !function(t) {
            var e = function() {
                return function(e, n, r) {
                    if (this.color = new t.Color(1,1,1,1),
                    e < 0)
                        throw new Error("index must be >= 0.");
                    if (null == n)
                        throw new Error("name cannot be null.");
            ...
            var e = function() {
                ...
                return e.prototype.addTexture = function(e, n) {
                    ...
                    if (null === o) {
                        ...
                        var l = n.baseTexture;
                        o.width = l.realWidth,
                            o.height = l.realHeight,
                            o.baseTexture = l,
                            o.minFilter = o.magFilter = t.TextureFilter.Nearest,
                            o.uWrap = t.TextureWrap.ClampToEdge,
                            o.vWrap = t.TextureWrap.ClampToEdge,
                            a.push(o)
                    }
                    var h = new i;
                    return h.name = e,
                        ...
                        var l = new n(e)
                            ...
                            for (; ; ) {
                                ...
                                if (0 == (e = e.trim()).length)
                                    ...
                                    if (!u) {
                                        (u = new r).name = e,
                                        2 == l.readTuple(h) && (u.width = parseInt(h[0]),
                                            u.height = parseInt(h[1]),
                                            l.readTuple(h)),
                                            l.readTuple(h),
                                            u.minFilter = t.Texture.filterFromString(h[0]),
                                            u.magFilter = t.Texture.filterFromString(h[1]);
                                        var n = l.readValue();
                                        u.uWrap = t.TextureWrap.ClampToEdge,
                                            u.vWrap = t.TextureWrap.ClampToEdge,
                                            "x" == n ? u.uWrap = t.TextureWrap.Repeat : "y" == n ? u.vWrap = t.TextureWrap.Repeat : "xy" == n && (u.uWrap = u.vWrap = t.TextureWrap.Repeat),
                                            a(e, function(t) {
                                                u.baseTexture = t,
                                                t.hasLoaded || (t.width = u.width,
                                                    t.height = u.height),
                                                    s.pages.push(u),
                                                    u.setFilters(),
                                                u.width && u.height || (u.width = t.realWidth,
                                                    u.height = t.realHeight,
                                                u.width && u.height || console.log("ERROR spine atlas page " + u.name + ": meshes wont work if you dont specify size in atlas (http://www.html5gamedevs.com/topic/18888-pixi-spines-and-meshes/?p=107121)")),
                                                    c()
                                            }),
                                            s.pages.push(u);
                                        break
                                    ...
                                    var g = parseInt(h[0])
                                        , v = parseInt(h[1])
                                        , y = u.baseTexture.resolution;
                                    d /= y,
                                        m /= y,
                                        g /= y,
                                        v /= y;
                                    var x = new PIXI.Rectangle(d,m,f ? v : g,f ? g : v);
                                    4 == l.readTuple(h) && 4 == l.readTuple(h) && l.readTuple(h);
                                    var M = parseInt(h[0]) / y
                                        , w = parseInt(h[1]) / y;
                                    l.readTuple(h);
                                    var E = parseInt(h[0]) / y
                                        , T = parseInt(h[1]) / y
                                        , b = new PIXI.Rectangle(0,0,M,w)
                                        , A = new PIXI.Rectangle(E,w - v - T,g,v);
                                    if ("3" != PIXI.VERSION[0])
                                        p.texture = new PIXI.Texture(p.page.baseTexture,x,b,A,f);
                                    else {
                                        var I = new PIXI.Rectangle(d,m,g,v)
                                            , S = I.clone();
                                        A.width = M,
                                            A.height = w,
                                            p.texture = new PIXI.Texture(p.page.baseTexture,I,S,A,f)
                                    }
                                    p.index = parseInt(l.readValue()),
                                        p.texture._updateUvs(),
                                        s.regions.push(p)
                                }
                            }
                        };
            ...
            var n = function() {
                ...
                return t.prototype.readLine = function() {
                    ...
                    t.prototype.readTuple = function(t) {
                        ...
                        for (var r = 0, i = n + 1; r < 3; r++) {
                            ...
                            if (-1 == a)
                                break;
                            t[r] = e.substr(i, a - i).trim(),
                                i = a + 1
                        }
                        return t[r] = e.substring(i).trim(),
                        r + 1
                    }
                    ,
                    t
                ...
                return e.prototype.setFilters = function() {
                    var e = this.baseTexture
                        , n = this.minFilter;
                    n == t.TextureFilter.Linear ? e.scaleMode = PIXI.SCALE_MODES.LINEAR : this.minFilter == t.TextureFilter.Nearest ? e.scaleMode = PIXI.SCALE_MODES.NEAREST : (e.mipmap = !0,
                        n == t.TextureFilter.MipMapNearestNearest ? e.scaleMode = PIXI.SCALE_MODES.NEAREST : e.scaleMode = PIXI.SCALE_MODES.LINEAR)
                }
                    ,
                    e
            }();
            ...
            var e = function() {
                function e(e, n) {
                    ...
                    for (var r = 0; r < e.bones.length; r++)
                        this.bones.push(n.findBone(e.bones[r].name));
                ...
                return e.prototype.apply = function() {
                        ...
                        for (var e = this.rotateMix, n = this.translateMix, r = this.scaleMix, i = this.shearMix, a = this.target, o = a.matrix, s = o.a, l = o.c, h = o.b, u = o.d, c = s * u - l * h > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad, p = this.data.offsetRotation * c, f = this.data.offsetShearY * c, d = this.bones, m = 0, g = d.length; m < g; m++) {
                            ...
                            if (0 != e) {
                                var M = x.a
                                    ...
                                    , E = x.b
                                    , T = x.d;
                                (P = Math.atan2(h, s) - Math.atan2(E, M) + p) > t.MathUtils.PI ? P -= t.MathUtils.PI2 : P < -t.MathUtils.PI && (P += t.MathUtils.PI2),
                                    P *= e;
                                var b = Math.cos(P)
                                    , A = Math.sin(P);
                                x.a = b * M - A * E,
                            ...
                            if (0 != n) {
                                var I = this.temp;
                                a.localToWorld(I.set(this.data.offsetX, this.data.offsetY)),
                                    x.tx += (I.x - x.tx) * n,
                                    x.ty += (I.y - x.ty) * n,
                                    y = !0
                            }
                            if (r > 0) {
                                var S = Math.sqrt(x.a * x.a + x.b * x.b)
                                    , R = Math.sqrt(s * s + h * h);
                                S > 1e-5 && (S = (S + (R - S + this.data.offsetScaleX) * r) / S),
                                    x.a *= S,
                                    x.b *= S,
                                    S = Math.sqrt(x.c * x.c + x.d * x.d),
                                    R = Math.sqrt(l * l + u * u),
                                S > 1e-5 && (S = (S + (R - S + this.data.offsetScaleY) * r) / S),
                                    x.c *= S,
                                    x.d *= S,
                                    y = !0
                            }
                            if (i > 0) {
                                w = x.c,
                                    T = x.d;
                                var P, C = Math.atan2(T, w);
                                (P = Math.atan2(u, l) - Math.atan2(h, s) - (C - Math.atan2(x.b, x.a))) > t.MathUtils.PI ? P -= t.MathUtils.PI2 : P < -t.MathUtils.PI && (P += t.MathUtils.PI2),
                                    P = C + (P + f) * i;
                                S = Math.sqrt(w * w + T * T);
                                x.c = Math.cos(P) * S,
                                    x.d = Math.sin(P) * S,
                        ...
                        for (var e = this.rotateMix, n = this.translateMix, r = this.scaleMix, i = this.shearMix, a = this.target, o = a.matrix, s = o.a, l = o.c, h = o.b, u = o.d, c = s * u - l * h > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad, p = this.data.offsetRotation * c, f = this.data.offsetShearY * c, d = this.bones, m = 0, g = d.length; m < g; m++) {
                            ...
                            if (0 != e) {
                                var M = x.a
                                    ...
                                    , E = x.b
                                    , T = x.d;
                                (R = Math.atan2(h, s) + p) > t.MathUtils.PI ? R -= t.MathUtils.PI2 : R < -t.MathUtils.PI && (R += t.MathUtils.PI2),
                                    R *= e;
                                var b = Math.cos(R)
                                    , A = Math.sin(R);
                                x.a = b * M - A * E,
                            ...
                            if (r > 0) {
                                var S = (Math.sqrt(s * s + h * h) - 1 + this.data.offsetScaleX) * r + 1;
                                x.a *= S,
                                    x.b *= S,
                                    S = (Math.sqrt(l * l + u * u) - 1 + this.data.offsetScaleY) * r + 1,
                                    x.c *= S,
                                    x.d *= S,
                                    y = !0
                            }
                            if (i > 0) {
                                ...
                                w = x.c,
                                    T = x.d;
                                R = Math.atan2(T, w) + (R - t.MathUtils.PI / 2 + f) * i;
                                S = Math.sqrt(w * w + T * T);
                                x.c = Math.cos(R) * S,
                                    x.d = Math.sin(R) * S,
                                    y = !0
                    ...
                    e.prototype.applyAbsoluteLocal = function() {
                        ...
                        for (var a = this.bones, o = 0, s = a.length; o < s; o++) {
                            ...
                            0 != e && (c += (i.ax - c + this.data.offsetX) * e,
                                p += (i.ay - p + this.data.offsetY) * e);
                            var f = l.ascaleX
                                , d = l.ascaleY;
                            n > 0 && (f > 1e-5 && (f = (f + (i.ascaleX - f + this.data.offsetScaleX) * n) / f),
                            d > 1e-5 && (d = (d + (i.ascaleY - d + this.data.offsetScaleY) * n) / d));
                            var m = l.ashearY;
                            if (r > 0) {
                                u = i.ashearY - m + this.data.offsetShearY;
                    ...
                    e.prototype.applyRelativeLocal = function() {
                        ...
                        for (var a = this.bones, o = 0, s = a.length; o < s; o++) {
                            ...
                            var u = l.ax
                                , c = l.ay;
                            0 != e && (u += (i.ax + this.data.offsetX) * e,
                                c += (i.ay + this.data.offsetY) * e);
                            var p = l.ascaleX
                                , f = l.ascaleY;
                            n > 0 && (p > 1e-5 && (p *= (i.ascaleX - 1 + this.data.offsetScaleX) * n + 1),
                            f > 1e-5 && (f *= (i.ascaleY - 1 + this.data.offsetScaleY) * n + 1));
                            var d = l.ashearY;
                            r > 0 && (d += (i.ashearY + this.data.offsetShearY) * r),
                                l.updateWorldTransformWith(u, c, h, p, f, l.ashearX, d)
                        }
                    }
                    ,
                    e.prototype.getOrder = function() {
        ...
        !function(t) {
            var e = function() {
                ...
                return e.prototype.triangulate = function(t) {
                    ...
                    a = 0;
                    for (var s = r; a < s; ++a)
                        o[a] = e.isConcave(a, r, n, i);
                    var l = this.triangles;
                    for (l.length = 0; r > 3; ) {
                        for (var h = r - 1, u = (a = 0,
                            1); ; ) {
                            t: if (!o[a]) {
                                for (var c = i[h] << 1, p = i[a] << 1, f = i[u] << 1, d = n[c], m = n[c + 1], g = n[p], v = n[p + 1], y = n[f], x = n[f + 1], M = (u + 1) % r; M != h; M = (M + 1) % r)
                                    if (o[M]) {
                                        var w = i[M] << 1
                                            , E = n[w]
                                            , T = n[w + 1];
                                        if (e.positiveArea(y, x, d, m, E, T) && e.positiveArea(d, m, g, v, E, T) && e.positiveArea(g, v, y, x, E, T))
                                            break t
                                    }
                                break
                            }
                        ...
                        var b = (--r + a - 1) % r
                            , A = a == r ? 0 : a;
                        o[b] = e.isConcave(b, r, n, i),
                            o[A] = e.isConcave(A, r, n, i)
                    }
                    return 3 == r && (l.push(i[2]),
                        l.push(i[0]),
                        l.push(i[1])),
                        l
                }
                    ...
                    e.prototype.decompose = function(t, n) {
                        ...
                        this.polygonPool.freeAll(i),
                            i.length = 0;
                        var a = this.convexPolygonsIndices;
                        this.polygonIndicesPool.freeAll(a),
                            a.length = 0;
                        ...
                        for (var l = -1, h = 0, u = 0, c = n.length; u < c; u += 3) {
                            ...
                            if (l == p) {
                                var E = s.length - 4
                                    , T = e.winding(s[E], s[E + 1], s[E + 2], s[E + 3], x, M)
                            ...
                            w || (s.length > 0 ? (i.push(s),
                                a.push(o)) : (this.polygonPool.free(s),
                                this.polygonIndicesPool.free(o)),
                                (s = this.polygonPool.obtain()).length = 0,
                                s.push(m),
                                s.push(g),
                                s.push(v),
                                s.push(y),
                        ...
                        for (u = 0,
                                 c = i.length; u < c; u++)
                            if (0 != (o = a[u]).length)
                                for (var A = o[0], I = o[o.length - 1], S = (s = i[u])[E = s.length - 4], R = s[E + 1], P = s[E + 2], C = s[E + 3], _ = s[0], V = s[1], k = s[2], N = s[3], D = e.winding(S, R, P, C, _, V), X = 0; X < c; X++)
                                    if (X != u) {
                                        var U = a[X];
                                        if (3 == U.length) {
                                            var O = U[0]
                                            ...
                                            x = L[L.length - 2],
                                                M = L[L.length - 1];
                                            if (O == A && Y == I) {
                                                T = e.winding(S, R, P, C, x, M),
                                                    b = e.winding(x, M, _, V, k, N);
                                                T == D && b == D && (L.length = 0,
                                                    U.length = 0,
                                                    s.push(x),
                                                    s.push(M),
                        ...
                        for (u = i.length - 1; u >= 0; u--)
                            0 == (s = i[u]).length && (i.splice(u, 1),
                                this.polygonPool.free(s),
                                o = a[u],
                                a.splice(u, 1),
                                this.polygonIndicesPool.free(o));
                        return i
            ...
            var s = function() {
                ...
                return t.arrayCopy = function(t, e, n, r, i) {
                    ...
                    t.ensureArrayCapacity = function(e, n, r) {
                        return void 0 === r && (r = 0),
                            e.length >= n ? e : t.setArraySize(e, n, r)
                    }
                    ,
        ...
        !function(t) {
            ...
            var n = function(t) {
                function e(n) {
                    ...
                    return r.id = (65535 & e.nextID++) << 11,
                        r.worldVerticesLength = 0,
                        r
                }
                return __extends(e, t),
                    e.prototype.computeWorldVerticesOld = function(t, e) {
                    ...
                    e.prototype.computeWorldVertices = function(t, e, n, r, i, a) {
                        ...
                        if (null != h) {
                                ...
                                for (R = i,
                                    ...
                                    for (g += u; u < g; u++,
                                        ...
                                        M = f[h[u]].matrix,
                                            ...
                                            C = l[b + 1];
                                        var v = l[b + 2];
                                        d += (P * M.a + C * M.c + M.tx) * v,
                                            m += (P * M.b + C * M.d + M.ty) * v
                                    }
                                    r[R] = d,
                                        r[R + 1] = m
                                }
                            ...
                            s.length > 0 && (l = s);
                            for (var M, w = (M = t.bone.matrix).tx, E = M.ty, T = M.a, b = M.c, A = M.b, I = M.d, S = e, R = i; R < n; S += 2,
                                R += a) {
                                var P = l[S]
                                    , C = l[S + 1];
                                r[R] = P * T + C * b + w,
        ...
        !function(t) {
            var e = function(e) {
                function n(n) {
                    ...
                    return r.color = new t.Color(1,1,1,1),
                        r
                }
    ...
    function(t) {
        !function(t) {
            var e = function(e) {
                function n(n) {
                    var r = e.call(this, n) || this;
                    return r.color = new t.Color(.2275,.2275,.8078,1),
                        r
                }
                return __extends(n, e),
                    n
        ...
        !function(t) {
            var e = function(e) {
                function n(n) {
                    ...
                    return r.color = new t.Color(1,1,1,1),
                        r.inheritDeform = !1,
                        r.tempColor = new t.Color(0,0,0,0),
                        r
                }
                return __extends(n, e),
                    n.prototype.updateUVs = function(e, n) {
                        var r = this.regionUVs.length;
                        if (n && n.length == r || (n = t.Utils.newFloatArray(r)),
                        null != e) {
                            for (var i = e.texture._uvs, a = e.width, o = e.height, s = e.originalWidth, l = e.originalHeight, h = e.offsetX, u = e.pixiOffsetY, c = 0; c < r; c += 2) {
                                var p = this.regionUVs[c]
                                    , f = this.regionUVs[c + 1];
                                p = (p * s - h) / a,
                                    f = (f * l - u) / o,
                                    n[c] = (i.x0 * (1 - p) + i.x1 * p) * (1 - f) + (i.x3 * (1 - p) + i.x2 * p) * f,
                                    n[c + 1] = (i.y0 * (1 - p) + i.y1 * p) * (1 - f) + (i.y3 * (1 - p) + i.y2 * p) * f
                            }
                            return n
                        }
                    }
    ...
    function(t) {
        !function(t) {
            var e = function(e) {
                function n(n) {
                    var r = e.call(this, n) || this;
                    return r.color = new t.Color(.38,.94,0,1),
                        r
                }
                return __extends(n, e),
                    n.prototype.computeWorldPosition = function(t, e) {
                        var n = t.matrix;
            ...
            var e = function(e) {
                function n(n) {
                    ...
                    return r.x = 0,
                        ...
                        r.height = 0,
                        r.color = new t.Color(1,1,1,1),
                        r.offset = t.Utils.newFloatArray(8),
                        r.uvs = t.Utils.newFloatArray(8),
                        r.tempColor = new t.Color(1,1,1,1),
                        r
                }
                return __extends(n, e),
        ...
        !function(t) {
            var e = function() {
                ...
                return e.prototype.begin = function(t) {}
                    ,
                    e.prototype.transform = function(e, n, r, i) {
                    ...
                    e.prototype.transform = function(n, r, i, a) {
                        ...
                        if (h < this.radius) {
                            var u = e.interpolation.apply(0, o, (this.radius - h) / this.radius)
                                , c = Math.cos(u)
                                , p = Math.sin(u);
                            n.x = c * s - p * l + this.worldX,
                                n.y = p * s + c * l + this.worldY
                        }
                    }
                    ,
                    e.prototype.end = function() {}
    ...
    function() {
        var t;
        Math.fround || (Math.fround = Math.fround = (t = new Float32Array(1),
                function(e) {
                    return t[0] = e,
                        t[0]
                }
    ...
    function(t) {
        ...
        var i = function(i) {
            function o(e) {
                ...
                n.spineData = e,
                    n.skeleton = new t.core.Skeleton(e),
                    n.skeleton.updateWorldTransform(),
                    n.stateData = new t.core.AnimationStateData(e),
                    n.state = new t.core.AnimationState(n.stateData),
                    n.slotContainers = [],
                    n.tempClipContainers = [];
                for (var r = 0, a = n.skeleton.slots.length; r < a; r++) {
                    var o = n.skeleton.slots[r]
                        , s = o.attachment
                        , l = n.newContainer();
                    if (n.slotContainers.push(l),
                        n.addChild(l),
                        n.tempClipContainers.push(null),
                    s instanceof t.core.RegionAttachment) {
                        var h = s.region.name
                            , u = n.createSprite(o, s, h);
                        o.currentSprite = u,
                            o.currentSpriteName = h,
                            l.addChild(u)
                    } else if (s instanceof t.core.MeshAttachment) {
                        var c = n.createMesh(o, s);
                        o.currentMesh = c,
                            o.currentMeshName = s.name,
                            l.addChild(c)
                    } else {
                        if (!(s instanceof t.core.ClippingAttachment))
                            continue;
                        n.createGraphics(o, s),
                            l.addChild(o.clippingContainer),
                            l.addChild(o.currentGraphics)
                    }
                }
                return n.autoUpdate = !0,
                    n.tintRgb = new Float32Array([1, 1, 1]),
                    n
            }
            return __extends(o, i),
                Object.defineProperty(o.prototype, "autoUpdate", {
                    get: function() {
                ...
                o.prototype.update = function(n) {
                    ...
                    var r = this.skeleton.slots
                        ...
                        , s = null;
                    i ? (o = i.light,
                        s = i.dark) : o = this.tintRgb;
                    for (var l = PIXI.TransformBase && 1 == this.transformHack(), h = 0, u = r.length; h < u; h++) {
                        var c = (_ = r[h]).attachment
                            , p = this.slotContainers[h];
                        if (c) {
                            var f = null
                                , d = c.color;
                            if (c instanceof t.core.RegionAttachment) {
                                var m = c.region;
                                if (m) {
                                    _.currentMesh && (_.currentMesh.visible = !1,
                                        _.currentMesh = null,
                                        _.currentMeshName = void 0);
                                    var g = m;
                                    if (!_.currentSpriteName || _.currentSpriteName !== g.name) {
                                        var v = g.name;
                                        if (_.currentSprite && (_.currentSprite.visible = !1),
                                            _.sprites = _.sprites || {},
                                        void 0 !== _.sprites[v])
                                            _.sprites[v].visible = !0;
                                        else {
                                            var y = this.createSprite(_, c, v);
                                            p.addChild(y)
                                        }
                                        _.currentSprite = _.sprites[v],
                                            _.currentSpriteName = v
                                    }
                                }
                                if (p.transform) {
                                    var x = w = p.transform
                                        , M = null;
                                    x.matrix2d ? (M = x.matrix2d,
                                        x._dirtyVersion++,
                                        x.version = x._dirtyVersion,
                                        x.isStatic = !0,
                                        x.operMode = 0) : l ? (x.position && ((w = new PIXI.TransformBase)._parentID = -1,
                                        w._worldID = p.transform._worldID,
                                        p.transform = w),
                                        M = w.localTransform) : x.setFromMatrix(_.bone.matrix),
                                    M && _.bone.matrix.copy(M)
                                } else {
                                    M = p.localTransform || new PIXI.Matrix;
                                    _.bone.matrix.copy(M),
                                        p.localTransform = M,
                                        p.displayObjectUpdateTransform = a
                                }
                                _.currentSprite.color ? f = _.currentSprite.color : (e[0] = o[0] * _.color.r * d.r,
                                    e[1] = o[1] * _.color.g * d.g,
                                    e[2] = o[2] * _.color.b * d.b,
                                    _.currentSprite.tint = PIXI.utils.rgb2hex(e)),
                                    _.currentSprite.blendMode = _.blendMode
                            } else if (c instanceof t.core.MeshAttachment) {
                                var w;
                                if (_.currentSprite)
                                    if (_.currentSprite.visible = !1,
                                        _.currentSprite = null,
                                        _.currentSpriteName = void 0,
                                        p.transform)
                                        (w = new PIXI.TransformStatic)._parentID = -1,
                                            w._worldID = p.transform._worldID,
                                            p.transform = w;
                                    else
                                        p.localTransform = new PIXI.Matrix,
                                            p.displayObjectUpdateTransform = PIXI.DisplayObject.prototype.updateTransform;
                                if (!_.currentMeshName || _.currentMeshName !== c.name) {
                                    var E = c.name;
                                    if (_.currentMesh && (_.currentMesh.visible = !1),
                                        _.meshes = _.meshes || {},
                                    void 0 !== _.meshes[E])
                                        _.meshes[E].visible = !0;
                                    else {
                                        var T = this.createMesh(_, c);
                                        p.addChild(T)
                                    }
                                    _.currentMesh = _.meshes[E],
                                        _.currentMeshName = E
                                }
                                if (c.computeWorldVerticesOld(_, _.currentMesh.vertices),
                                    _.currentMesh.color)
                                    f = _.currentMesh.color;
                                else if ("3" !== PIXI.VERSION[0]) {
                                    var b = _.currentMesh.tintRgb;
                                    b[0] = o[0] * _.color.r * d.r,
                                        b[1] = o[1] * _.color.g * d.g,
                                        b[2] = o[2] * _.color.b * d.b
                                }
                                _.currentMesh.blendMode = _.blendMode
                            } else {
                                if (!(c instanceof t.core.ClippingAttachment)) {
                                    p.visible = !1;
                                    continue
                                }
                                _.currentGraphics || (this.createGraphics(_, c),
                                    p.addChild(_.clippingContainer),
                                    p.addChild(_.currentGraphics)),
                                    this.updateGraphics(_, c)
                            }
                            if (p.visible = !0,
                                f) {
                                var A = _.color.r * d.r
                                    , I = _.color.g * d.g
                                    , S = _.color.b * d.b;
                                f.setLight(o[0] * A + s[0] * (1 - A), o[1] * I + s[1] * (1 - I), o[2] * S + s[2] * (1 - S)),
                                    _.darkColor ? (A = _.darkColor.r,
                                        I = _.darkColor.g,
                                        S = _.darkColor.b) : (A = 0,
                                        I = 0,
                                        S = 0),
                                    f.setDark(o[0] * A + s[0] * (1 - A), o[1] * I + s[1] * (1 - I), o[2] * S + s[2] * (1 - S))
                            }
                            p.alpha = _.color.a
                        } else
                            p.visible = !1
                    ...
                    for (h = 0,
                             u = R.length; h < u; h++) {
                        var _ = r[R[h].data.index];
                        p = this.slotContainers[R[h].data.index];
                        if (C || p.parent !== this && (p.parent.removeChild(p),
                            p.parent = this),
                        _.currentGraphics && _.attachment)
                            C = _.clippingContainer,
                                P = _.attachment,
                                C.children.length = 0,
                                this.children[h] = p,
                            P.endSlot == _.data && (P.endSlot = null);
                        else if (C) {
                            var V = this.tempClipContainers[h];
                            V || ((V = this.tempClipContainers[h] = this.newContainer()).visible = !1),
                                this.children[h] = V,
                                p.parent = null,
                                C.addChild(p),
                            P.endSlot == _.data && (C.renderable = !0,
                                C = null,
                                P = null)
                        } else
                            this.children[h] = p
                ...
                o.prototype.createSprite = function(e, n, r) {
                    var i = n.region;
                    e.tempAttachment === n && (i = e.tempRegion,
                        e.tempAttachment = null,
                        e.tempRegion = null);
                    var a = i.texture
                        , o = this.newSprite(a);
                    return o.rotation = n.rotation * t.core.MathUtils.degRad,
                        o.anchor.x = .5,
                        o.anchor.y = .5,
                        o.position.x = n.x,
                        o.position.y = n.y,
                ...
                o.prototype.createMesh = function(t, e) {
                    var n = e.region;
                    t.tempAttachment === e && (n = t.tempRegion,
                        t.tempAttachment = null,
                        t.tempRegion = null);
                    ...
                    return r.canvasPadding = 1.5,
                        r.alpha = e.color.a,
                        r.region = e.region,
                        this.setMeshRegion(e, r, n),
                        t.meshes = t.meshes || {},
                        t.meshes[e.name] = r,
                        r
                }
                ...
                o.prototype.updateGraphics = function(t, e) {
                    ...
                    n.length = r,
                        ...
                        t.currentGraphics.dirty++,
                        t.currentGraphics.clearDirty++
                }
                ,
                o.prototype.hackTextureBySlotIndex = function(e, n, r) {
                    ...
                    var a = i.attachment
                        , o = a.region;
                    return n && ((o = new t.core.TextureRegion).texture = n,
                        o.size = r),
                        i.currentSprite && i.currentSprite.region != o ? (this.setSpriteRegion(a, i.currentSprite, o),
                            i.currentSprite.region = o) : i.currentMesh && i.currentMesh.region != o ? this.setMeshRegion(a, i.currentMesh, o) : (i.tempRegion = o,
                            i.tempAttachment = a),
                        !0
                }
                ,
                ...
                ,
                o.prototype.newMesh = function(t, e, n, i, a) {
                    return new r(t,e,n,i,a)
                }
                ,
        ...
        function a() {
            ...
            e.a = n.a * t.a + n.b * t.c,
                ...
                e.c = n.c * t.a + n.d * t.c,
                e.d = n.c * t.b + n.d * t.d,
                e.tx = n.tx * t.a + n.ty * t.c + t.tx,
                e.ty = n.tx * t.b + n.ty * t.d + t.ty,
    ...
    function(t) {
        function e() {
            return function(e, i) {
                if (!e.data || !function(t) {
                    ...
                    return i();
                var a = e.metadata || {}
                    , o = a ? e.metadata.spineSkeletonScale : null
                    , s = a ? e.metadata.spineAtlas : null;
                if (!1 === s)
                    return i();
                if (s && s.pages) {
                    var l = new t.core.SkeletonJson(new t.core.AtlasAttachmentLoader(s)).readSkeletonData(e.data);
                    return e.spineData = l,
                        e.spineAtlas = s,
                        i()
                }
                var h = a.spineAtlasSuffix || ".atlas"
                    , u = e.url.substr(0, e.url.lastIndexOf(".")) + h;
                e.metadata && e.metadata.spineAtlasFile && (u = e.metadata.spineAtlasFile),
                    u = u.replace(this.baseUrl, "");
                var c = {
                    crossOrigin: e.crossOrigin,
                    xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.TEXT,
                    metadata: a.spineMetadata || null,
                    parentResource: e
                }
                    , p = {
                    crossOrigin: e.crossOrigin,
                    metadata: a.imageMetadata || null,
                    parentResource: e
                }
                    , f = e.url.substr(0, e.url.lastIndexOf("/") + 1);
                f = f.replace(this.baseUrl, "");
                var d = a.images ? r(a.images) : a.image ? r({
                    default: a.image
                }) : a.imageLoader ? a.imageLoader(this, e.name + "_atlas_page_", f, p) : n(this, e.name + "_atlas_page_", f, p)
                    , m = function(n) {
                    new t.core.TextureAtlas(n,d,function(n) {
                            var r = new t.core.SkeletonJson(new t.core.AtlasAttachmentLoader(n));
                            o && (r.scale = o),
                                e.spineData = r.readSkeletonData(e.data),
                                e.spineAtlas = n,
                                i()
                        }
                    )
                };
                e.metadata && e.metadata.atlasRawData ? m(e.metadata.atlasRawData) : this.add(e.name + "_atlas", u, c, function(t) {
                    m(t.xhr.responseText)
                })
            }
        }
        function n(t, e, n, r) {
        ...
        t.atlasParser = e,
            ...
            ,
            t.staticImageLoader = r,
            PIXI.loaders.Loader.addPixiMiddleware(e),
            PIXI.loader.use(e())
    }(pixi_spine || (pixi_spine = {}));
